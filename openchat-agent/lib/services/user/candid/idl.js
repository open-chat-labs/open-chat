export const idlFactory = ({ IDL }) => {
    ...
    return IDL.Service({
        ...
        'add_recommended_group_exclusions': IDL.Func([AddRecommendedGroupExclusionsArgs], [AddRecommendedGroupExclusionsResponse], []),
        'archive_chat': IDL.Func([ArchiveChatArgs], [ArchiveChatResponse], []),
        'assume_group_super_admin': IDL.Func([AssumeGroupSuperAdminArgs], [AssumeGroupSuperAdminResponse], []),
        ...
        'init_user_principal_migration': IDL.Func([InitUserPrincipalMigrationArgs], [InitUserPrincipalMigrationResponse], []),
        ...
        'messages_by_message_index': IDL.Func([MessagesByMessageIndexArgs], [MessagesByMessageIndexResponse], ['query']),
        'migrate_user_principal': IDL.Func([MigrateUserPrincipalArgs], [MigrateUserPrincipalResponse], []),
        ...
        'recommended_groups': IDL.Func([RecommendedGroupsArgs], [RecommendedGroupsResponse], ['query']),
        'relinquish_group_super_admin': IDL.Func([RelinquishGroupSuperAdminArgs], [RelinquishGroupSuperAdminResponse], []),
        'remove_reaction': IDL.Func([RemoveReactionArgs], [RemoveReactionResponse], []),
        'search_all_messages': IDL.Func([SearchAllMessagesArgs], [SearchAllMessagesResponse], ['query']),
        ...
        'transfer_crypto_within_group_v2': IDL.Func([TransferCryptoWithinGroupArgs], [TransferCryptoWithinGroupResponse], []),
        'unarchive_chat': IDL.Func([UnArchiveChatArgs], [UnArchiveChatResponse], []),
        'unblock_user': IDL.Func([UnblockUserArgs], [UnblockUserResponse], []),
        'unmute_notifications': IDL.Func([UnmuteNotificationsArgs], [UnmuteNotificationsResponse], []),
