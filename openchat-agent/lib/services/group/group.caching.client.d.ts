...
import { ChatSchema } from "../../utils/caching";
 ...
 */
export declare class CachingGroupClient implements IGroupClient {
    private db;
    private chatId;
    private client;
    constructor(db: Promise<IDBPDatabase<ChatSchema>>, chatId: string, client: IGroupClient);
    ...
    chatEventsWindow(eventIndexRange: IndexRange, messageIndex: number, latestClientEventIndex: number | undefined, interrupt?: ServiceRetryInterrupt): Promise<EventsResponse<GroupChatEvent>>;
