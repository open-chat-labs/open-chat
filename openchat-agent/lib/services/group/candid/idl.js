export const idlFactory = ({ IDL }) => {
    ...
    return IDL.Service({
        ...
        'disable_invite_code': IDL.Func([DisableInviteCodeArgs], [DisableInviteCodeResponse], []),
        'edit_message': IDL.Func([EditMessageArgs], [EditMessageResponse], []),
        'enable_invite_code': IDL.Func([EnableInviteCodeArgs], [EnableInviteCodeResponse], []),
        ...
        'public_summary': IDL.Func([PublicSummaryArgs], [PublicSummaryResponse], ['query']),
        'register_poll_vote': IDL.Func([RegisterPollVoteArgs], [RegisterPollVoteResponse], []),
        'register_proposal_vote': IDL.Func([RegisterProposalVoteArgs], [RegisterProposalVoteResponse], []),
        'remove_participant': IDL.Func([RemoveParticipantArgs], [RemoveParticipantResponse], []),
        'remove_reaction': IDL.Func([RemoveReactionArgs], [RemoveReactionResponse], []),
        'reset_invite_code': IDL.Func([ResetInviteCodeArgs], [ResetInviteCodeResponse], []),
        'rules': IDL.Func([RulesArgs], [RulesResponse], ['query']),
        'search_messages': IDL.Func([SearchMessagesArgs], [SearchMessagesResponse], ['query']),
        'selected_initial': IDL.Func([SelectedInitialArgs], [SelectedInitialResponse], ['query']),
        'selected_updates': IDL.Func([SelectedUpdatesArgs], [SelectedUpdatesResponse], ['query']),
        'send_message': IDL.Func([SendMessageArgs], [SendMessageResponse], []),
        'thread_previews': IDL.Func([ThreadPreviewsArgs], [ThreadPreviewsResponse], ['query']),
