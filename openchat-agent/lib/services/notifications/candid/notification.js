            ...
            'event': IDL.Record({
                ...
                'content': IDL.Variant({
                    ...
                    'File': IDL.Record({
                        ...
                        'mime_type': IDL.Text,
                        'file_size': IDL.Nat32,
                        'blob_reference': IDL.Opt(IDL.Record({ 'blob_id': IDL.Nat, 'canister_id': IDL.Principal })),
                        'caption': IDL.Opt(IDL.Text),
                    }),
                    'Poll': IDL.Record({
                        'votes': IDL.Record({
                    ...
                    'Video': IDL.Record({
                        'height': IDL.Nat32,
                        'image_blob_reference': IDL.Opt(IDL.Record({ 'blob_id': IDL.Nat, 'canister_id': IDL.Principal })),
                        'video_blob_reference': IDL.Opt(IDL.Record({ 'blob_id': IDL.Nat, 'canister_id': IDL.Principal })),
                        'mime_type': IDL.Text,
                        'thumbnail_data': IDL.Text,
                        'caption': IDL.Opt(IDL.Text),
                        'width': IDL.Nat32,
