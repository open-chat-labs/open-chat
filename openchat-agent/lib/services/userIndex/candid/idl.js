export const idlFactory = ({ IDL }) => {
    ...
    const UsersArgs = IDL.Record({
        'user_groups': IDL.Vec(IDL.Record({
    ...
    return IDL.Service({
        'add_super_admin': IDL.Func([AddSuperAdminArgs], [AddSuperAdminResponse], []),
        'check_username': IDL.Func([CheckUsernameArgs], [CheckUsernameResponse], ['query']),
        'confirm_phone_number': IDL.Func([ConfirmPhoneNumberArgs], [ConfirmPhoneNumberResponse], []),
        'create_challenge': IDL.Func([CreateChallengeArgs], [CreateChallengeResponse], []),
        'current_user': IDL.Func([CurrentUserArgs], [CurrentUserResponse], ['query']),
        'register_user': IDL.Func([RegisterUserArgs], [RegisterUserResponse], []),
        'remove_super_admin': IDL.Func([RemoveSuperAdminArgs], [RemoveSuperAdminResponse], []),
        ...
        'submit_phone_number': IDL.Func([SubmitPhoneNumberArgs], [SubmitPhoneNumberResponse], []),
        'super_admins': IDL.Func([SuperAdminsArgs], [SuperAdminsResponse], ['query']),
        'upgrade_storage': IDL.Func([UpgradeStorageArgs], [UpgradeStorageResponse], []),
