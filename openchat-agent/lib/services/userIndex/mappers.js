...
export function userSearchResponse(candid) {
...
export function usersResponse(candid) {
    if ("Success" in candid) {
        const timestamp = candid.Success.timestamp;
        return {
...
export function partialUserSummary(candid, timestamp) {
...
export function userSummary(candid, timestamp) {
    return {
        kind: candid.is_bot ? "bot" : "user",
...
export function submitPhoneNumberResponse(candid) {
    if ("Success" in candid) {
        return "success";
    }
    ...
    throw new UnsupportedValueError("Unexpected ApiSubmitPhoneNumberResponse type received", candid);
}
export function createChallengeResponse(candid) {
...
export function registerUserResponse(candid) {
...
export function confirmPhoneNumber(candid) {
    if ("Success" in candid)
        return {
            kind: "success",
    ...
    throw new UnsupportedValueError("Unexpected ApiConfirmPhoneNumberResponse type received", candid);
}
export function phoneNumber(candid) {
    return {
        countryCode: candid.country_code,
        number: candid.number,
    };
}
export function upgradeStorageResponse(candid) {
...
export function currentUserResponse(candid) {
    if ("Success" in candid) {
        ...
        return {
            ...
            canisterUpgradeStatus: "Required" in r.canister_upgrade_status
                ? "required"
...
export function phoneStatus(candid) {
...
export function checkUsernameResponse(candid) {
    if ("Success" in candid) {
        return "success";
    }
    if ("UsernameTaken" in candid) {
...
export function setUsernameResponse(candid) {
    if ("Success" in candid) {
        return "success";
    }
    if ("UsernameTaken" in candid) {
...
export function resendCodeResponse(candid) {
    if ("Success" in candid) {
        return "success";
    }
