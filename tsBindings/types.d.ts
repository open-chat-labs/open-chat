...
export type UserIndexDeleteUserResponse = "Success" | "NotAuthorized" | "UserNotFound";
...
export type BotDefinition = { description: string, commands: Array<SlashCommandSchema>, };
...
export type GroupSelectedInitialSuccessResult = { timestamp: bigint, last_updated: bigint, latest_event_index: EventIndex, participants: Array<GroupMember>, bots: Array<BotGroupDetails>, basic_members: Array<UserId>, blocked_users: Array<UserId>, invited_users: Array<UserId>, pinned_messages: Array<MessageIndex>, chat_rules: VersionedRules, };
...
export type AccessTokenBotCommand = { user_id: UserId, bot: UserId, chat: Chat, thread_root_message_index?: MessageIndex | undefined, message_id: MessageId, command: BotCommand, };
export type BotMessageContext = { initiator: UserId, command: BotCommand, finalised: boolean, };
/**
 * @default NoChange
 */
