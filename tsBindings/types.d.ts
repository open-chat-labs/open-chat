...
export type ProposalsBotStakeNeuronForSubmittingProposalsArgs = { governance_canister_id: TSBytes, stake: bigint, };
export type ProposalsBotTopUpNeuronArgs = { governance_canister_id: TSBytes, amount: bigint, };
