export type ProposalsBotCommonExecuteGenericNervousSystemFunction = { function_id: bigint, payload: Uint8Array, };
...
export type Document = { id: bigint, mime_type: string, data: Uint8Array, };
export type CustomContent = { kind: string, data: Uint8Array, };
...
export type RegistryTokenDetails = { ledger_canister_id: PrincipalTS, name: string, symbol: string, decimals: number, fee: bigint, logo: string, logo_id?: bigint, info_url: string, how_to_buy_url: string, transaction_url_format: string, supported_standards: Array<string>, added: bigint, enabled: boolean, last_updated: bigint, };
...
export type LocalUserIndexRegisterUserArgs = { username: string, referral_code?: string, public_key: Uint8Array, };
...
export type StorageBucketForwardFileArgs = { file_id: bigint, accessors: Array<PrincipalTS>, };
...
export type UserManualWallet = { tokens: Array<PrincipalTS>, };
...
export type UserLocalUserIndexResponse = { "Success": PrincipalTS };
...
export type GroupChatSummary = { chat_id: ChatId, local_user_index_canister_id: PrincipalTS, last_updated: bigint, name: string, description: string, subtype?: GroupSubtype, avatar_id?: bigint, is_public: boolean, history_visible_to_new_joiners: boolean, messages_visible_to_non_members: boolean, min_visible_event_index: EventIndex, min_visible_message_index: MessageIndex, latest_message?: EventWrapperMessage, latest_event_index: EventIndex, latest_message_index?: MessageIndex, joined: bigint, read_by_me_up_to?: MessageIndex, notifications_muted: boolean, participant_count: number, role: GroupRole, mentions: Array<HydratedMention>, wasm_version: BuildVersion, permissions_v2: GroupPermissions, metrics: ChatMetrics, my_metrics: ChatMetrics, latest_threads: Array<ThreadSyncDetails>, archived: boolean, frozen?: FrozenGroupInfo, date_last_pinned?: bigint, date_read_pinned?: bigint, events_ttl?: bigint, events_ttl_last_updated: bigint, gate?: AccessGate, rules_accepted: boolean, video_call_in_progress?: VideoCall, };
