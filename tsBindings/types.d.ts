...
export type ExchangeId = "ICPSwap" | "KongSwap";
...
export type UserSwapTokensExchangeArgs = { "ICPSwap": UserSwapTokensICPSwapArgs } | { "KongSwap": UserSwapTokensICPSwapArgs };
...
export type SlashCommandParam = { name: string, description?: string, placeholder?: string, required: boolean, param_type: SlashCommandParamType, };
