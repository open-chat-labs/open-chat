...
export type DateTimeParam = { future_only: boolean, };
...
export type StringParam = { min_length: number, max_length: number, choices: Array<BotCommandOptionChoiceString>, multi_line: boolean, };
...
export type BotCommandParamType = "UserParam" | "BooleanParam" | { "StringParam": StringParam } | { "IntegerParam": IntegerParam } | { "DecimalParam": DecimalParam } | { "DateTimeParam": DateTimeParam };
