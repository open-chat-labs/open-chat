...
export type CommunityToggleMuteNotificationsArgs = { channel_id?: bigint, mute: boolean, };
...
export type CommunityDeleteMessageArgs = { channel_id: bigint, thread_root_message_index?: MessageIndex, message_id: MessageId, };
...
export type CommunityCancelP2pSwapArgs = { channel_id: bigint, thread_root_message_index?: MessageIndex, message_id: MessageId, };
...
export type CommunityChannelSummaryUpdatesArgs = { channel_id: bigint, invite_code?: bigint, updates_since: bigint, };
...
export type CommunityDeleteMessagesArgs = { channel_id: bigint, thread_root_message_index?: MessageIndex, message_ids: Array<MessageId>, as_platform_moderator?: boolean, new_achievement: boolean, };
...
export type CommunityChannelSummaryArgs = { channel_id: bigint, invite_code?: bigint, };
...
export type CommunityAddReactionArgs = { channel_id: bigint, thread_root_message_index?: MessageIndex, message_id: MessageId, reaction: Reaction, username: string, display_name?: string, new_achievement: boolean, };
...
export type CommunityThreadPreviewsArgs = { channel_id: bigint, threads: Array<MessageIndex>, latest_client_thread_update?: bigint, };
...
export type CommunityEventsByIndexArgs = { channel_id: bigint, thread_root_message_index?: MessageIndex, events: Array<EventIndex>, latest_known_update?: bigint, };
export type CommunityLocalUserIndexResponse = { "Success": TSBytes };
export type CommunityEventsArgs = { channel_id: bigint, thread_root_message_index?: MessageIndex, start_index: EventIndex, ascending: boolean, max_messages: number, max_events: number, latest_known_update?: bigint, };
...
export type GroupAcceptP2pSwapArgs = { thread_root_message_index?: MessageIndex, message_id: MessageId, pin?: string, new_achievement: boolean, };
...
export type GateCheckFailedReason = "NotDiamondMember" | "NotLifetimeDiamondMember" | "NoUniquePersonProof" | "NoSnsNeuronsFound" | "NoSnsNeuronsWithRequiredStakeFound" | "NoSnsNeuronsWithRequiredDissolveDelayFound" | { "PaymentFailed": TransferFromError } | { "InsufficientBalance": bigint } | { "FailedVerifiedCredentialCheck": string } | "Locked" | "NotReferredByMember" | "Unknown";
...
export type CommunityCancelInvitesArgs = { channel_id?: bigint, user_ids: Array<UserId>, };
export type CommunityCreateUserGroupArgs = { name: string, user_ids: Array<UserId>, };
export type CommunitySearchChannelArgs = { channel_id: bigint, search_term: string, max_results: number, users?: Array<UserId>, };
...
export type CommunityAddMembersToChannelArgs = { channel_id: bigint, user_ids: Array<UserId>, added_by_name: string, added_by_display_name?: string, };
...
export type CommunityDeleteMessageSuccessResult = { content: MessageContent, };
...
export type UserCreateGroupArgs = { is_public: boolean, name: string, description: string, rules: Rules, avatar?: Document, history_visible_to_new_joiners: boolean, messages_visible_to_non_members?: boolean, permissions_v2?: GroupPermissions, events_ttl?: bigint, gate?: AccessGate, gate_config?: AccessGateConfig, };
