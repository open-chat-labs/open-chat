...
export type StringParam = { min_length: number, max_length: number, choices: SlashCommandOptionChoiceString, };
...
export type GroupIndexExploreBotsArgs = { search_term?: string | undefined, page_index: number, page_size: number, };
...
export type GroupIndexExploreBotsSuccessResult = { matches: Array<BotMatch>, total: number, };
