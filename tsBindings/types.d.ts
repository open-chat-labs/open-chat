 ...
 * @default BigIntZero
 */
export type TSBigIntWithDefault = bigint;
...
export type MessageId = TSBigIntWithDefault;
...
export type StorageIndexCanForwardArgs = { file_hash: [number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number], file_size: TSBigIntWithDefault, };
export type StorageIndexUserUserRecord = { byte_limit: TSBigIntWithDefault, bytes_used: TSBigIntWithDefault, };
...
export type RegistryAddMessageFilterResponse = { "Success": TSBigIntWithDefault } | "NotAuthorized" | "AlreadyAdded" | { "InvalidRequest": string } | { "InternalError": string };
export type RegistryMessageFilterSummary = { id: TSBigIntWithDefault, regex: string, };
export type RegistryRemoveMessageFilterResponse = "Success" | "NotAuthorized" | "NotFound" | { "InternalError": string };
export type RegistryRemoveMessageFilterArgs = { id: TSBigIntWithDefault, };
...
export type UserIndexExternalAchievementsArgs = { updates_since: TSBigIntWithDefault, };
...
export type UserIndexPayForDiamondMembershipArgs = { duration: DiamondMembershipPlanDuration, token: Cryptocurrency, expected_price_e8s: TSBigIntWithDefault, recurring: TSBoolWithDefault, };
...
export type CommunitySelectedChannelUpdatesArgs = { channel_id: bigint, updates_since: TSBigIntWithDefault, };
...
export type CommunityEnableInviteCodeSuccessResult = { code: TSBigIntWithDefault, };
...
export type CommunitySendMessageSuccessResult = { event_index: TSNumberWithDefault, message_index: TSNumberWithDefault, timestamp: TSBigIntWithDefault, expires_at?: bigint | undefined, };
...
export type CommunitySelectedUpdatesArgs = { invite_code?: bigint | undefined, updates_since: TSBigIntWithDefault, };
...
export type GroupSummaryUpdatesArgs = { updates_since: TSBigIntWithDefault, };
export type GroupToggleMuteNotificationsArgs = { mute: TSBoolWithDefault, };
export type GroupClaimPrizeArgs = { message_id: MessageId, correlation_id: TSBigIntWithDefault, };
...
export type GroupEnableInviteCodeArgs = { correlation_id: TSBigIntWithDefault, };
export type GroupEnableInviteCodeSuccessResult = { code: TSBigIntWithDefault, };
...
export type GroupDisableInviteCodeArgs = { correlation_id: TSBigIntWithDefault, };
...
export type GroupPinMessageArgs = { message_index: TSNumberWithDefault, correlation_id: TSBigIntWithDefault, };
export type GroupVideoCallParticipantsArgs = { message_id: MessageId, updated_since?: bigint | undefined, };
export type GroupSendMessageSuccessResult = { event_index: TSNumberWithDefault, message_index: TSNumberWithDefault, timestamp: TSBigIntWithDefault, expires_at?: bigint | undefined, };
...
export type GroupUnpinMessageArgs = { message_index: TSNumberWithDefault, correlation_id: TSBigIntWithDefault, };
export type GroupLocalUserIndexResponse = { "Success": TSBytes };
export type GroupSelectedUpdatesArgs = { updates_since: TSBigIntWithDefault, };
export type GroupFollowThreadArgs = { thread_root_message_index: TSNumberWithDefault, };
export type UserMessageActivitySummary = { read_up_to: TSBigIntWithDefault, latest_event: TSBigIntWithDefault, unread_count: TSNumberWithDefault, };
export type UserMarkAchievementsSeenArgs = { last_seen: TSBigIntWithDefault, };
export type UserSavedCryptoAccountsResponse = { "Success": Array<UserNamedAccount> };
export type UserTokenSwapStatusArgs = { swap_id: TSBigIntWithDefault, };
export type UserTokenSwapStatusTokenSwapStatus = { started: TSBigIntWithDefault, icrc2: TSBoolWithDefault, auto_withdrawals: TSBoolWithDefault, deposit_account: { Ok : null } | { Err : string } | null, transfer: { Ok : bigint } | { Err : string } | null, transfer_or_approval: { Ok : bigint } | { Err : string } | null, notify_dex: { Ok : null } | { Err : string } | null, amount_swapped: { Ok : { Ok : bigint } | { Err : string } } | { Err : string } | null, withdraw_from_dex: { Ok : bigint } | { Err : string } | null, success?: boolean | undefined, };
export type UserSwapTokensICPSwapArgs = { swap_canister_id: TSBytes, zero_for_one: TSBoolWithDefault, };
export type UserSwapTokensSuccessResult = { amount_out: TSBigIntWithDefault, };
...
export type UserUpdatesArgs = { updates_since: TSBigIntWithDefault, };
...
export type UserClaimDailyChitSuccessResult = { chit_earned: TSNumberWithDefault, chit_balance: TSNumberWithDefault, streak: TSNumberWithDefault, next_claim: TSBigIntWithDefault, };
export type UserClaimDailyChitResponse = { "Success": UserClaimDailyChitSuccessResult } | { "AlreadyClaimed": TSBigIntWithDefault };
export type UserSetMessageReminderResponse = { "Success": TSBigIntWithDefault } | "ReminderDateInThePast" | { "NotesTooLong": FieldTooLongResult } | "UserSuspended";
export type UserTokenSwapsArgs = { start: TSNumberWithDefault, max_results: TSNumberWithDefault, };
export type UserReclaimSwapTokensArgs = { exchange_id: ExchangeId, swap_canister_id: TSBytes, ledger_canister_id: TSBytes, amount: TSBigIntWithDefault, fee: TSBigIntWithDefault, };
...
export type UserRetrieveBtcResponse = { "Success": TSBigIntWithDefault } | { "ApproveError": string } | { "RetrieveBtcError": string } | { "InternalError": string };
export type UserRetrieveBtcArgs = { amount: TSBigIntWithDefault, address: string, };
...
export type UserCancelMessageReminderArgs = { reminder_id: TSBigIntWithDefault, };
...
export type ChatMetrics = { text_messages: TSBigIntWithDefault, image_messages: TSBigIntWithDefault, video_messages: TSBigIntWithDefault, audio_messages: TSBigIntWithDefault, file_messages: TSBigIntWithDefault, polls: TSBigIntWithDefault, poll_votes: TSBigIntWithDefault, icp_messages: TSBigIntWithDefault, sns1_messages: TSBigIntWithDefault, ckbtc_messages: TSBigIntWithDefault, chat_messages: TSBigIntWithDefault, kinic_messages: TSBigIntWithDefault, deleted_messages: TSBigIntWithDefault, giphy_messages: TSBigIntWithDefault, prize_messages: TSBigIntWithDefault, prize_winner_messages: TSBigIntWithDefault, replies: TSBigIntWithDefault, edits: TSBigIntWithDefault, reactions: TSBigIntWithDefault, proposals: TSBigIntWithDefault, reported_messages: TSBigIntWithDefault, message_reminders: TSBigIntWithDefault, custom_type_messages: TSBigIntWithDefault, last_active: TSBigIntWithDefault, };
export type BlobReference = { canister_id: TSBytes, blob_id: TSBigIntWithDefault, };
export type PendingCryptoTransactionICRC1 = { ledger: TSBytes, token: Cryptocurrency, amount: TSBigIntWithDefault, to: AccountICRC1, fee: TSBigIntWithDefault, memo?: TSBytes | undefined, created: TSBigIntWithDefault, };
...
export type TokenBalanceGate = { ledger_canister_id: TSBytes, min_balance: TSBigIntWithDefault, };
export type TokenInfo = { token: Cryptocurrency, ledger: TSBytes, decimals: TSNumberWithDefault, fee: TSBigIntWithDefault, };
export type AcceptSwapSuccess = { token1_txn_in: TSBigIntWithDefault, };
/**
 * @default NoChange
 */
...
export type Tokens = { e8s: TSBigIntWithDefault, };
...
export type FailedCryptoTransactionNNS = { ledger: TSBytes, token: Cryptocurrency, amount: Tokens, fee: Tokens, from: CryptoAccountNNS, to: CryptoAccountNNS, memo: TSBigIntWithDefault, created: TSBigIntWithDefault, transaction_hash: [number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number], error_message: string, };
...
export type CommunityMember = { user_id: UserId, date_added: TSBigIntWithDefault, role: CommunityRole, display_name?: string | undefined, referred_by?: UserId | undefined, lapsed: TSBoolWithDefault, };
 ...
 * @default []
 */
participant_ids: Array<UserId>, followed_by_me: TSBoolWithDefault, reply_count: TSNumberWithDefault, latest_event_index: TSNumberWithDefault, latest_event_timestamp: TSBigIntWithDefault, };
/**
 * @default NoChange
 */
...
export type CommunitySelectedInitialSuccessResult = { timestamp: TSBigIntWithDefault, last_updated: TSBigIntWithDefault, latest_event_index: TSNumberWithDefault, 
/**
 * @default []
 */
members: Array<CommunityMember>, 
 ...
 */
user_ids: Array<UserId>, };
export type OnlineUsersLastOnlineUserLastOnline = { user_id: UserId, duration_since_last_online: TSBigIntWithDefault, };
...
export type GroupRegisterPollVoteArgs = { thread_root_message_index?: MessageIndex | undefined, message_index: TSNumberWithDefault, poll_option: TSNumberWithDefault, operation: VoteOperation, new_achievement: TSBoolWithDefault, correlation_id: TSBigIntWithDefault, };
...
export type GroupUnblockUserArgs = { user_id: UserId, correlation_id: TSBigIntWithDefault, };
 ...
 */
threads: Array<MessageIndex>, latest_client_thread_update?: bigint | undefined, };
export type GroupBlockUserArgs = { user_id: UserId, correlation_id: TSBigIntWithDefault, };
...
export type UserSendMessageSuccessResult = { chat_id: ChatId, event_index: TSNumberWithDefault, message_index: TSNumberWithDefault, timestamp: TSBigIntWithDefault, expires_at?: bigint | undefined, };
...
export type CompletedCryptoTransactionICRC2 = { ledger: TSBytes, token: Cryptocurrency, amount: TSBigIntWithDefault, spender: UserId, from: CryptoAccountICRC1, to: CryptoAccountICRC1, fee: TSBigIntWithDefault, memo?: TSBytes | undefined, created: TSBigIntWithDefault, block_index: TSBigIntWithDefault, };
 ...
 * @default []
 */
winners: Array<UserId>, winner_count: TSNumberWithDefault, user_is_winner: TSBoolWithDefault, token: Cryptocurrency, end_date: TSBigIntWithDefault, caption?: string | undefined, diamond_only: TSBoolWithDefault, };
...
export type P2PSwapCompleted = { accepted_by: UserId, token1_txn_in: TSBigIntWithDefault, token0_txn_out: TSBigIntWithDefault, token1_txn_out: TSBigIntWithDefault, };
...
export type DeletedBy = { deleted_by: UserId, timestamp: TSBigIntWithDefault, };
export type P2PSwapAccepted = { accepted_by: UserId, token1_txn_in: TSBigIntWithDefault, };
...
export type CallParticipant = { user_id: UserId, joined: TSBigIntWithDefault, };
...
export type FailedCryptoTransactionICRC2 = { ledger: TSBytes, token: Cryptocurrency, amount: TSBigIntWithDefault, fee: TSBigIntWithDefault, spender: UserId, from: CryptoAccountICRC1, to: CryptoAccountICRC1, memo?: TSBytes | undefined, created: TSBigIntWithDefault, error_message: string, };
...
export type SelectedGroupUpdates = { timestamp: TSBigIntWithDefault, last_updated: TSBigIntWithDefault, latest_event_index: TSNumberWithDefault, 
/**
 * @default []
 */
...
export type CommunitySelectedChannelUpdatesResponse = { "Success": SelectedGroupUpdates } | { "SuccessNoUpdates": TSBigIntWithDefault } | "PrivateCommunity" | "ChannelNotFound" | "PrivateChannel";
...
export type GroupSelectedInitialSuccessResult = { timestamp: TSBigIntWithDefault, last_updated: TSBigIntWithDefault, latest_event_index: TSNumberWithDefault, 
/**
 * @default []
 */
...
export type UserSetMessageReminderArgs = { chat: Chat, thread_root_message_index?: MessageIndex | undefined, event_index: TSNumberWithDefault, notes?: string | undefined, remind_at: TSBigIntWithDefault, };
...
export type EventWrapperGroupUnfrozen = { index: TSNumberWithDefault, timestamp: TSBigIntWithDefault, correlation_id: TSBigIntWithDefault, expires_at?: bigint | undefined, event: GroupUnfrozen, };
...
export type UserSendMessageWithTransferToGroupSuccessResult = { event_index: TSNumberWithDefault, message_index: TSNumberWithDefault, timestamp: TSBigIntWithDefault, expires_at?: bigint | undefined, transfer: CompletedCryptoTransaction, };
...
export type UserSendMessageTransferSuccessV2Result = { chat_id: ChatId, event_index: TSNumberWithDefault, message_index: TSNumberWithDefault, timestamp: TSBigIntWithDefault, expires_at?: bigint | undefined, transfer: CompletedCryptoTransaction, };
 ...
 * @default []
 */
mentioned: Array<User>, block_level_markdown: TSBoolWithDefault, correlation_id: TSBigIntWithDefault, rules_accepted?: Version | undefined, message_filter_failed?: bigint | undefined, pin?: string | undefined, };
...
export type EventWrapperChatEvent = { index: TSNumberWithDefault, timestamp: TSBigIntWithDefault, correlation_id: TSBigIntWithDefault, expires_at?: bigint | undefined, event: ChatEvent, };
...
export type CommunityCanisterChannelSummary = { channel_id: bigint, last_updated: TSBigIntWithDefault, name: string, description: string, subtype?: GroupSubtype | undefined, avatar_id?: bigint | undefined, is_public: TSBoolWithDefault, history_visible_to_new_joiners: TSBoolWithDefault, messages_visible_to_non_members: TSBoolWithDefault, min_visible_event_index: TSNumberWithDefault, min_visible_message_index: TSNumberWithDefault, latest_message?: EventWrapperMessage | undefined, latest_message_sender_display_name?: string | undefined, latest_event_index: TSNumberWithDefault, latest_message_index?: MessageIndex | undefined, member_count: TSNumberWithDefault, permissions_v2: GroupPermissions, metrics: ChatMetrics, date_last_pinned?: bigint | undefined, events_ttl?: bigint | undefined, events_ttl_last_updated: TSBigIntWithDefault, gate?: AccessGate | undefined, gate_config?: AccessGateConfig | undefined, membership?: GroupMembership | undefined, video_call_in_progress?: VideoCall | undefined, is_invited?: boolean | undefined, external_url?: string | undefined, };
 ...
 * @default []
 */
threads: Array<ThreadPreview>, timestamp: TSBigIntWithDefault, };
...
export type GroupThreadPreviewsResponse = { "Success": GroupThreadPreviewsSuccessResult } | "CallerNotInGroup" | { "ReplicaNotUpToDate": TSBigIntWithDefault };
