...
export class DataService {
    public async getData(key: string, totalBytes?: number, chunkSize?: number) : Promise<Option<Uint8Array>> {
    ...
    public async putData(key: string, data: Uint8Array, unchunked?: boolean): Promise<boolean> {
        if (unchunked) {
