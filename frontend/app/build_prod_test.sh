...
export OC_INTERNET_IDENTITY_URL=https://id.ai/?feature_flag_guided_upgrade=true
...
export OC_CUSTOM_DOMAINS=test.oc.app,pfs7b-iqaaa-aaaaf-abs7q-cai.ic0.app,pfs7b-iqaaa-aaaaf-abs7q-cai.icp0.io
