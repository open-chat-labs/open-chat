<script lang="ts">
    ...
    import DirectAndGroupChatsHeader from "@src/mobile/features/chats/community/DirectAndGroupChatsHeader.svelte";
    import FavouriteChatsHeader from "@src/mobile/features/chats/community/FavouriteChatsHeader.svelte";
    import SelectedCommunityHeader from "@src/mobile/features/chats/community/SelectedCommunityHeader.svelte";
