<script lang="ts">
    ...
    import BotPublisher from "@src/mobile/features/bots/BotPublisher.svelte";
    import ErrorMessage from "@src/mobile/shared/ErrorMessage.svelte";
    import Legend from "@src/mobile/shared/Legend.svelte";
    ...
    import BalanceWithRefresh from "@src/mobile/shared/BalanceWithRefresh.svelte";
