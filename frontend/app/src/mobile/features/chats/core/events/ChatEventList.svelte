<script lang="ts">
    ...
    } from "@src/ui/ChatEventList.svelte";
    import type { FlatChatItem } from "@src/ui/flatChatItems";
    import { rtlStore } from "@src/stores/rtl";
    import { pop } from "@src/utils/transition";
    import TimelineDate from "@src/mobile/features/chats/core/TimelineDate.svelte";
