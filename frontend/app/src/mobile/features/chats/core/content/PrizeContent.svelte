<script lang="ts">
    ...
    import { claimsStore } from "@src/stores/claims";
    import { rtlStore } from "@src/stores/rtl";
    import { now500 } from "@src/stores/time";
    import { toastStore } from "@src/stores/toast";
    import Diamond from "@src/mobile/ui/icons/Diamond.svelte";
    import SpinningToken from "@src/mobile/ui/icons/SpinningToken.svelte";
    import SecureButton from "@src/mobile/features/chats/core/SecureButton.svelte";
    ...
    import ChitEarnedBadge from "@src/mobile/features/profile/ChitEarnedBadge.svelte";
    import ReAuthenticateModal from "@src/mobile/features/profile/ReAuthenticateModal.svelte";
    import Streak from "@src/mobile/features/profile/Streak.svelte";
    import MessageRenderer from "@src/mobile/features/chats/core/MessageRenderer.svelte";
    import { TokenState } from "@src/mobile/features/wallet/walletState.svelte";
    import TransferFeesMessage from "@src/mobile/shared/TransferFeesMessage.svelte";
