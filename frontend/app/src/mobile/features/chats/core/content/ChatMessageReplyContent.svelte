<script lang="ts">
    ...
    import ProposalContent from "@src/mobile/features/proposals/ProposalContent.svelte";
...
{:else if content.kind === "poll_content"}
    <PollContent {title} {readonly} {me} {content} {senderId} {reply} {edited} {onRegisterVote} />
