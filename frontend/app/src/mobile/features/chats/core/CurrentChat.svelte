<script lang="ts">
    ...
    import DirectChatHeader from "@src/mobile/features/bots/DirectChatHeader.svelte";
    ...
    import ExternalContent from "@src/mobile/features/chats/core/content/ExternalContent.svelte";
