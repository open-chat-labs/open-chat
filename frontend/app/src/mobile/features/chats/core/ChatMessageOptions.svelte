<script lang="ts">
    ...
    import { i18nKey, translationCodes } from "@src/i18n/i18n";
    import { now } from "@src/stores/time";
    import { toastStore } from "@src/stores/toast";
    import * as shareFunctions from "@src/utils/share";
    import { copyToClipboard } from "@src/utils/urls";
    import Bitcoin from "@src/mobile/ui/icons/Bitcoin.svelte";
    import Translatable from "@src/mobile/shared/Translatable.svelte";
    import { saveMediaToDevice } from "tauri-plugin-oc-api";
    import { getProxyAdjustedBlobUrl } from "@src/utils/media";
