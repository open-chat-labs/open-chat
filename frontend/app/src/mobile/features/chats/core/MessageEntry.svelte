<script lang="ts">
    import RichTextEditor from "@src/ui/RichTextEditor.svelte";
    ...
    import { enterSend } from "@src/stores/settings";
    import { snowing } from "@src/stores/snow";
    import AlertBoxModal from "./AlertBoxModal.svelte";
    import CommandBuilder from "@src/mobile/features/bots/CommandInstanceBuilder.svelte";
    import CommandSelector from "@src/mobile/features/bots/CommandSelector.svelte";
    import Send from "@src/mobile/ui/icons/Send.svelte";
    import Translatable from "@src/mobile/shared/Translatable.svelte";
    import AudioAttacher from "@src/mobile/features/chats/core/content/AudioAttacher.svelte";
    ...
    import FileAttacher from "@src/mobile/features/chats/core/content/FileAttacher.svelte";
