<script lang="ts">
    ...
    import BotMatch from "@src/mobile/features/bots/BotMatch.svelte";
    import BotMember from "@src/mobile/features/bots/BotMember.svelte";
    import WebhookMember from "@src/mobile/features/bots/WebhookMember.svelte";
