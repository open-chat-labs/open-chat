<script lang="ts">
    ...
    import {
        ...
        SearchState,
    } from "@src/stores/search.svelte";
    import FancyLoader from "@src/mobile/ui/icons/FancyLoader.svelte";
    ...
    import NothingToSee from "@src/mobile/shared/NothingToSee.svelte";
    import { updateCommunityState } from "@src/mobile/features/chats/community/createOrUpdate/community.svelte";
    import BotCard from "@src/mobile/features/bots/exports/BotCard.svelte";
