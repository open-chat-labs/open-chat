<script lang="ts">
    ...
    import EditableAvatar from "@src/mobile/shared/EditableAvatar.svelte";
    import EditableImageWrapper from "@src/mobile/shared/EditableImageWrapper.svelte";
    import LinkedCard from "@src/mobile/shared/LinkedCard.svelte";
    import Setting from "@src/mobile/shared/Setting.svelte";
    import Translatable from "@src/mobile/shared/Translatable.svelte";
    import AccessGateChip from "@src/mobile/features/access/AccessGateChip.svelte";
    import LanguageSelector from "@src/mobile/shared/LanguageSelector.svelte";
