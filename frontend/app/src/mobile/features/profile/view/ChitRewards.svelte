<script lang="ts">
    ...
    import Calendar from "@src/mobile/features/calendar/Calendar.svelte";
    import { calendarState, type DateRange } from "@src/mobile/features/calendar/calendarState.svelte";
    import Setting from "@src/mobile/shared/Setting.svelte";
    import Translatable from "@src/mobile/shared/Translatable.svelte";
    import ChitEventsForDay from "@src/mobile/features/profile/ChitEventsForDay.svelte";
