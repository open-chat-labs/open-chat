<script lang="ts">
    ...
    } from "@src/stores/androidInterfaceSizes";
    import { rtlStore } from "@src/stores/rtl";
    import { snowing } from "@src/stores/snow";
    import { incomingVideoCall } from "@src/stores/video";
    import { broadcastLoggedInUser } from "@src/stores/xframe";
    ...
    } from "@src/utils/native/notification_channels";
    import { expectShareTarget, handleShareTarget } from "@src/utils/native/share_target";
    import "@src/utils/scream";
    ...
    import { clearChatShortcuts, startChatShortcutPusher } from "@src/stores/chatShortcuts";
    import Head from "./Head.svelte";
    import NotificationsBar from "./NotificationsBar.svelte";
    import ActiveCall from "@src/mobile/features/calls/ActiveCall.svelte";
    import IncomingCall from "@src/mobile/features/calls/IncomingCall.svelte";
    import VideoCallAccessRequests from "@src/mobile/features/calls/VideoCallAccessRequests.svelte";
    import Router from "./Router.svelte";
    import Snow from "@src/ui/Snow.svelte";
