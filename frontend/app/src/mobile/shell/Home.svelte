<script lang="ts">
    ...
    import AreYouSure from "@src/mobile/shared/AreYouSure.svelte";
    import NativeUpgradeBanner from "./NativeUpgradeBanner.svelte";
    import NotFound from "./NotFound.svelte";
    import OfflineFooter from "./OfflineFooter.svelte";
    import OnboardModal from "@src/mobile/features/onboard/OnboardModal.svelte";
    import SuspendedModal from "./SuspendedModal.svelte";
    import Toast from "./Toast.svelte";
    import AcceptRulesModal from "@src/mobile/features/chats/core/AcceptRulesModal.svelte";
    import AnonFooter from "@src/mobile/features/onboard/AnonFooter.svelte";
    import ChitEarned from "@src/mobile/features/chit/ChitEarned.svelte";
    import LeftPanel from "./LeftPanel.svelte";
    import MiddlePanel from "./MiddlePanel.svelte";
    import NoAccess from "@src/mobile/features/access/NoAccess.svelte";
    import PinNumberModal from "@src/mobile/features/wallet/PinNumberModal.svelte";
    import VerifyHumanity from "@src/mobile/features/profile/VerifyHumanity.svelte";
    import ViewUserProfile from "@src/mobile/features/profile/ViewUserProfileModal.svelte";
    import MakeProposalModal from "@src/mobile/features/proposals/MakeProposalModal.svelte";
    import SuspendModal from "@src/mobile/features/profile/SuspendModal.svelte";
    import SetPinNumberModal from "@src/mobile/features/wallet/SetPinNumberModal.svelte";
