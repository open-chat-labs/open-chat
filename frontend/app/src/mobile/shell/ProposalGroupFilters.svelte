<script lang="ts">
    ...
    } from "@src/stores/proposalSections";
    import { OC_GOVERNANCE_CANISTER_ID } from "@src/utils/sns";
    import CollapsibleCard from "@src/mobile/features/landing/CollapsibleCard.svelte";
