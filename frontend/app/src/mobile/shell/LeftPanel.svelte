<script lang="ts">
    ...
    import ActivityFeed from "@src/mobile/features/activity/ActivityFeed.svelte";
    import BottomBar, { type Selection } from "@src/mobile/features/nav/BottomBar.svelte";
    import ChatList from "@src/mobile/features/chatlist/ChatList.svelte";
    import PreviewWrapper from "@src/mobile/features/chats/community/PreviewWrapper.svelte";
    import CommunitiesSheet from "@src/mobile/features/chats/community/CommunitiesSheet.svelte";
    import SlidingModals from "./SlidingModals.svelte";
    import UserProfileSummary from "@src/mobile/features/profile/view/UserProfileSummary.svelte";
    import ActiveCallSummary from "@src/mobile/features/calls/ActiveCallSummary.svelte";
    import Wallet from "@src/mobile/features/wallet/Wallet.svelte";
