<script lang="ts">
    ...
    import { pendingShareStore } from "@src/stores/pendingShare";
    import { navigate, parentRoute } from "@src/utils/navigation";
    ...
    import { expectBackPress } from "@src/utils/native/notification_channels";
    import { flushPendingNavigation, hasPendingNavigation } from "@src/utils/navigation";
    import type { Share as ShareType } from "@src/utils/share";
    import BotBuilderModal from "@src/mobile/features/bots/BotBuilderModal.svelte";
    import BotDetailsPage from "@src/mobile/features/bots/BotDetailsPage.svelte";
    import CommandViewer from "@src/mobile/features/bots/CommandViewer.svelte";
    import BotInstaller from "@src/mobile/features/bots/install/BotInstaller.svelte";
    import WebhookModal from "@src/mobile/features/bots/WebhookModal.svelte";
    import ForwardMessageModal from "./ForwardMessageModal.svelte";
    import ShareMessageModal from "./ShareMessageModal.svelte";
    import AccessGatesEvaluator from "@src/mobile/features/access/AccessGatesEvaluator.svelte";
    import AboutAccessGates from "@src/mobile/features/access/AboutAccessGates.svelte";
    import AccessGates from "@src/mobile/features/access/AccessGates.svelte";
    import BalanceGates from "@src/mobile/features/access/BalanceGates.svelte";
    import EditBalanceGate from "@src/mobile/features/access/EditBalanceGate.svelte";
    import EditChitGate from "@src/mobile/features/access/EditChitGate.svelte";
    import EditNeuronGate from "@src/mobile/features/access/EditNeuronGate.svelte";
    import EditPaymentGate from "@src/mobile/features/access/EditPaymentGate.svelte";
    import NeuronGates from "@src/mobile/features/access/NeuronGates.svelte";
    import PaymentGates from "@src/mobile/features/access/PaymentGates.svelte";
    import AddCommunityMembers from "@src/mobile/features/chats/community/createOrUpdate/AddCommunityMembers.svelte";
    import Channels from "@src/mobile/features/chats/community/createOrUpdate/Channels.svelte";
    import CommunityInfo from "@src/mobile/features/chats/community/createOrUpdate/CommunityInfo.svelte";
    import CommunityPermissions from "@src/mobile/features/chats/community/createOrUpdate/Permissions.svelte";
    import CommunitySummaryComponent from "@src/mobile/features/chats/community/details/CommunitySummary.svelte";
    import ConfirmDeleteCommunity from "@src/mobile/features/chats/community/details/ConfirmDelete.svelte";
    import EditUserGroup from "@src/mobile/features/chats/community/details/EditUserGroup.svelte";
    import UserGroup from "@src/mobile/features/chats/community/details/UserGroup.svelte";
    import UserGroups from "@src/mobile/features/chats/community/details/UserGroups.svelte";
    import AddGroupMembers from "@src/mobile/features/chats/group/edit/AddGroupMembers.svelte";
    import GroupInfo from "@src/mobile/features/chats/group/edit/GroupInfo.svelte";
    import GroupPermissions from "@src/mobile/features/chats/group/edit/Permissions.svelte";
    import ConfirmDeleteChat from "@src/mobile/features/chats/group/ConfirmDelete.svelte";
    import Convert from "@src/mobile/features/chats/group/Convert.svelte";
    import Converted from "@src/mobile/features/chats/group/Converted.svelte";
    import DirectChatDetails from "@src/mobile/features/chats/group/DirectChatDetails.svelte";
    import GroupDetails from "@src/mobile/features/chats/group/GroupDetails.svelte";
    import { UpdateGroupOrCommunityState } from "@src/mobile/shared/groupOrCommunity.svelte";
    import StreakInsuranceBuy from "@src/mobile/features/access/insurance/StreakInsuranceBuy.svelte";
    import Architecture from "@src/mobile/features/landing/Architecture.svelte";
    import BotsList from "@src/mobile/features/chats/members/BotsList.svelte";
    import InviteAndShare from "@src/mobile/features/chats/members/InviteAndShare.svelte";
    import MemberManagement from "@src/mobile/features/chats/members/MemberManagement.svelte";
    import NewMessage from "./NewMessage.svelte";
    import P2PSwapContentBuilder from "./P2PSwapContentBuilder.svelte";
    import PinnedMessages from "@src/mobile/features/chats/pinned/PinnedMessages.svelte";
    ...
    import Thread from "@src/mobile/features/chats/thread/Thread.svelte";
    import ThreadPreviews from "@src/mobile/features/chats/thread/ThreadPreviews.svelte";
    import Upgrade from "@src/mobile/features/upgrade/Upgrade.svelte";
    import About from "@src/mobile/features/profile/view/About.svelte";
    import Appearance from "@src/mobile/features/profile/view/Appearance.svelte";
    import AppSettings from "@src/mobile/features/profile/view/AppSettings.svelte";
    import BotConfig from "@src/mobile/features/profile/view/BotConfig.svelte";
    import ChatsAndVideo from "@src/mobile/features/profile/view/ChatsAndVideo.svelte";
    import ChitRewards from "@src/mobile/features/profile/view/ChitRewards.svelte";
    import ClearCache from "@src/mobile/features/profile/view/ClearCache.svelte";
    import CommunitySettings from "@src/mobile/features/profile/view/CommunitySettings.svelte";
    import DeleteAccount from "@src/mobile/features/profile/view/DeleteAccount.svelte";
    import Share from "@src/mobile/features/profile/view/Share.svelte";
    import UserInformation from "@src/mobile/features/profile/view/UserInformation.svelte";
    import Verify from "@src/mobile/features/profile/view/Verify.svelte";
    import ActiveCallParticipants from "@src/mobile/features/calls/ActiveCallParticipants.svelte";
    import EditRecipient from "@src/mobile/features/wallet/EditRecipient.svelte";
    import ManageRecipients from "@src/mobile/features/wallet/ManageRecipients.svelte";
    import ReceiveCrypto from "@src/mobile/features/wallet/ReceiveCrypto.svelte";
    import SendCrypto from "@src/mobile/features/wallet/SendCrypto.svelte";
    import SwapToken from "@src/mobile/features/wallet/SwapCrypto.svelte";
    import TokenPage from "@src/mobile/features/wallet/TokenPage.svelte";
    import WalletSettings from "@src/mobile/features/wallet/WalletSettings.svelte";
    import type { TokenState } from "@src/mobile/features/wallet/walletState.svelte";
    /**
    ...
    function push(modal: SlidingModalType) {
        if (!modalStack.find((m) => m.kind === modal.kind)) {
            ...
            pushDummyHistoryState("sliding_modal", true);
