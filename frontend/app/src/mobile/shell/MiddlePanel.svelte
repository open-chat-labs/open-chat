<script lang="ts">
    ...
    import { activeVideoCall, type ActiveVideoCall } from "@src/stores/video";
    import { currentTheme } from "@src/theme/themes";
    import ExploreCommunities from "@src/mobile/features/chats/community/explore/Explore.svelte";
    import CurrentChat from "@src/mobile/features/chats/core/CurrentChat.svelte";
