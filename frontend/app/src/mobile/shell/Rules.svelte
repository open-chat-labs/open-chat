<script lang="ts">
    ...
    import GroupCard from "@src/mobile/features/chats/group/edit/GroupCard.svelte";
    import { MAX_RULES_LENGTH, type UpdateGroupOrCommunityState } from "@src/mobile/shared/groupOrCommunity.svelte";
