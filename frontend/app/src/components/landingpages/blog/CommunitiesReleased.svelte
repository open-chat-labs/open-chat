...
<section>
    ...
    <p>
        While a lot has changed, things should feel still feel quite familiar. You will notice that
        you now see a new navigation bar on the left of the screen. Let's first run through what is
        available from this new navigation interface.
    </p>

    <p>
        At the top, you will see a root level menu. This will provide access to items that don't
        relate to specific communities, groups or channels. This includes a full breakdown of all of
        our landing pages which were not easily accessible from within the app before.
    </p>

    <p>
        Next you will see your own avatar. Click here to navigate to you user profile which will
        open to the right as before.
    </p>

    <p>
        Below your avatar you will see three new icons representing direct chats, global group chats
        and favourites. Direct chats are all the chats where you are having a one to one
        converstation with another user. Global group chats are exactly like group chats were
        before. They are simply groups that do not belong inside a Community. It's perfectly ok for
        groups to remain global and not form part of a new community. And finally we have favourite
        chats. This is a place where you can add <em>any</em> chat. Then if you would prefer to just
        have a single view with all of your favourite chats without worrying about the new categories
        you can set it up that way. By default you should see that any chat you previously had pinned
        will now automatically appear in your favourites list. It is still possible to pin chats within
        any of these three lists.
    </p>

    <p>
        Below the top level chat lists, you will see an avatar for each community that you belong
        to. A community <em>also</em> acts as a list of chats - when you select a community you will
        see those chats that belong to it. Chats within communities are referred to as "Channels" to
        make it clear that they are part of a community. Just like direct and group chats, channels can
        also be added to favourites so you can still have everything you're interested in in one place.
    </p>

    <p>
        Finally, at the bottom of the navigation panel you will see a link to explore communities.
        This is a good place to get started to find out what is on offer. In addition, there is a
        link to expand and collapse the navigation panel which will show labels next to each item
        making it clear exactly what everything is. You may find that you don't need to expand this
        panel after getting used to the new features.
    </p>
</section>
...
<section>
    ...
    <p>
        What about if you want to create a community of your own? There are a couple of common
        scenarios...
    </p>

    <h3>Create a community from scratch</h3>
    <p>
        To create a community from scratch, simply navigate to the Community explorer and click the
        Create Community button.
    </p>
    <p>
        The wizard should be relatively easy to understand and offers many similar choices to the
        existing group creation process. There are some key decisions that will need to be made. Do
        you want to create a public community which anyone can discover and join or would you prefer
        it to be private so that only those invited or provided with an invite link can join? Will
        you apply an access gate that users must pass?
    </p>

    <p>
        You will also need to set up permissions for the community to control what your users can
        do.
    </p>

    <p>
        You will also have an opportunity to quickly define one or more default channels. You will
        be able to further configure these channels later after the community has been created.
    </p>
