...
// Restore the selected web model once in browsers and explicitly enabled Android WebGPU builds.
// This shares the readiness path's in-flight restore and does not delay mounting either layout.
...
const app = (
    layout === "v2" ? import("./components_mobile/App.svelte") : import("./components/App.svelte")
