...
<script lang="ts">
    ...
    import { removeQueryStringParam, removeThreadMessageIndex } from "@src/utils/urls";
    import Resizable from "./Resizable.svelte";
    import ChannelOrCommunityInvite from "@src/desktop/features/chats/community/ChannelOrCommunityInvite.svelte";
    import ChannelOrCommunityMembers from "@src/desktop/features/chats/community/ChannelOrCommunityMembers.svelte";
    import ChannelOrCommunitySummary from "@src/desktop/features/chats/community/ChannelOrCommunitySummary.svelte";
    import CommunityDetails from "@src/desktop/features/chats/community/details/CommunitySummary.svelte";
    import CommunityFilters from "@src/desktop/features/chats/community/explore/Filters.svelte";
    import DirectChatDetails from "@src/desktop/features/chats/group/DirectChatDetails.svelte";
    import GroupDetails from "@src/desktop/features/chats/group/GroupDetails.svelte";
    import InviteUsers from "@src/desktop/features/chats/group/InviteUsers.svelte";
    import Members from "@src/desktop/features/chats/group/Members.svelte";
    import PinnedMessages from "@src/desktop/features/chats/pinned/PinnedMessages.svelte";
    import UserProfile from "@src/desktop/features/profile/UserProfile.svelte";
    import ProposalGroupFilters from "@src/desktop/features/proposals/ProposalGroupFilters.svelte";
    import Thread from "@src/desktop/features/chats/thread/Thread.svelte";
    import ActiveCallParticipants from "@src/desktop/features/calls/ActiveCallParticipants.svelte";
