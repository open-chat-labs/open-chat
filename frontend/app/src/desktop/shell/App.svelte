<script lang="ts">
    ...
    import { reviewingTranslations } from "@src/i18n/i18n";
    ...
    import Witch from "@src/ui/Witch.svelte";
    import InstallPrompt from "./InstallPrompt.svelte";
    import NotificationsBar from "./NotificationsBar.svelte";
    import ActiveCall from "@src/desktop/features/calls/ActiveCall.svelte";
    import IncomingCall from "@src/desktop/features/calls/IncomingCall.svelte";
    import VideoCallAccessRequests from "@src/desktop/features/calls/VideoCallAccessRequests.svelte";
