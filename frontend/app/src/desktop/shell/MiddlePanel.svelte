<script lang="ts">
    ...
    import UninstalledDirectBot from "@src/desktop/features/bots/UninstalledDirectBot.svelte";
    import Loading from "@src/ui/Loading.svelte";
    import ExploreCommunities from "@src/desktop/features/chats/community/explore/Explore.svelte";
    import CurrentChat from "@src/desktop/features/chats/core/CurrentChat.svelte";
    import NoChatSelected from "@src/desktop/features/chats/core/NoChatSelected.svelte";
    import RecommendedGroups from "@src/desktop/features/chats/community/RecommendedGroups.svelte";
...
<section
    ...
    {:else if $routeStore.kind === "admin_route"}
        {#await import("@src/desktop/features/admin/Admin.svelte")}
            <div class="loading">
                <Loading />
            </div>
        {:then { default: Admin }}
