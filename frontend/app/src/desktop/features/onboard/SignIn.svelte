<script lang="ts">
    ...
    import EmailSigninFeedback from "@src/desktop/shared/EmailSigninFeedback.svelte";
    import ChooseSignInOption from "@src/desktop/features/profile/ChooseSignInOption.svelte";
...
{:else if loggingInWithEth}
    {#await import("@src/desktop/shared/SigninWithEth.svelte")}
        <div class="loading">...</div>
    {:then { default: SigninWithEth }}
        <SigninWithEth />
    {/await}
{:else if loggingInWithSol}
    {#await import("@src/desktop/shared/SigninWithSol.svelte")}
        <div class="loading">...</div>
