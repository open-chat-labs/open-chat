<script lang="ts">
    ...
    import BlogSummary from "@src/desktop/features/landing/blog/BlogSummary.svelte";
    import { type BlogPostInfo, postsBySlug } from "@src/desktop/features/landing/blog/posts";
