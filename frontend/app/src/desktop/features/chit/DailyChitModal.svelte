<script lang="ts">
    import InfoIcon from "@src/desktop/shared/InfoIcon.svelte";
    ...
    import Progress from "@src/desktop/shared/Progress.svelte";
    import Translatable from "@src/ui/Translatable.svelte";
    import StreakInsuranceBuy from "@src/desktop/features/access/insurance/StreakInsuranceBuy.svelte";
    import ChitBalance from "@src/desktop/features/profile/ChitBalance.svelte";
    import LearnToEarn from "@src/desktop/features/profile/LearnToEarn.svelte";
    import Streak from "@src/desktop/features/profile/Streak.svelte";
