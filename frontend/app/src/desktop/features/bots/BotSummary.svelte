<script lang="ts">
    ...
    import BotProperties from "@src/desktop/features/bots/install/BotProperties.svelte";
    import ChoosePermissions from "@src/desktop/features/bots/install/ChoosePermissions.svelte";
