...
<script lang="ts">
    ...
    import { reservedMediaWidth } from "@src/utils/media";
    ...
    import BotMessageContext from "@src/desktop/features/bots/BotMessageContext.svelte";
    import BotProfile, { type BotProfileProps } from "@src/desktop/features/bots/BotProfile.svelte";
    ...
    import RoleIcon from "@src/desktop/features/profile/RoleIcon.svelte";
    import WithRole from "@src/desktop/features/profile/WithRole.svelte";
