<script lang="ts">
    ...
    import ActiveBroadcastSummary from "@src/desktop/features/calls/ActiveBroadcastSummary.svelte";
    import ActiveVideoCallResume from "@src/desktop/features/calls/ActiveVideoCallResume.svelte";
