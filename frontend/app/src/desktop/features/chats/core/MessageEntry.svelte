<script lang="ts">
    ...
    import CommandBuilder from "@src/desktop/features/bots/CommandInstanceBuilder.svelte";
    import CommandSelector from "@src/desktop/features/bots/CommandSelector.svelte";
    ...
    import AudioAttacher from "@src/desktop/features/chats/core/content/AudioAttacher.svelte";
    import EmojiAutocompleter from "./EmojiAutocompleter.svelte";
    import MentionPicker from "@src/desktop/shared/MentionPicker.svelte";
