<script lang="ts">
    ...
    import AcceptP2PSwapModal from "@src/desktop/features/chats/core/AcceptP2PSwapModal.svelte";
    import Markdown from "@src/ui/Markdown.svelte";
    import P2PSwapProgress from "@src/desktop/features/chats/core/P2PSwapProgress.svelte";
