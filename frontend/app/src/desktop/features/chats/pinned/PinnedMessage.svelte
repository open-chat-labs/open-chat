<script lang="ts">
    ...
    import RepliesTo from "@src/desktop/features/chats/core/RepliesTo.svelte";
    import UnresolvedReply from "@src/desktop/features/chats/core/UnresolvedReply.svelte";
