<script lang="ts">
    ...
    import ChooseMembers from "@src/desktop/features/chats/core/ChooseMembers.svelte";
    import GroupPermissionsEditor from "./GroupPermissionsEditor.svelte";
    import GroupPermissionsViewer from "@src/desktop/features/chats/group/GroupPermissionsViewer.svelte";
    import RulesEditor from "@src/desktop/features/chats/core/RulesEditor.svelte";
    import StageHeader from "@src/desktop/features/chats/core/StageHeader.svelte";
    import VisibilityControl from "@src/desktop/features/chats/core/VisibilityControl.svelte";
