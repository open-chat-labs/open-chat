<script lang="ts">
    ...
    import AccessGateExpiry from "@src/desktop/features/access/AccessGateExpiry.svelte";
    import AccessGateSummary from "@src/desktop/features/access/AccessGateSummary.svelte";
    ...
    import InviteUsersWithLink from "@src/desktop/features/chats/core/InviteUsersWithLink.svelte";
    import Markdown from "@src/ui/Markdown.svelte";
    import Stats from "@src/desktop/shared/Stats.svelte";
