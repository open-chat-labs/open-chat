<script lang="ts">
    ...
    import { randomSentence } from "@src/utils/randomMsg";
    import AreYouSure from "@src/desktop/shared/AreYouSure.svelte";
    import Loading from "@src/ui/Loading.svelte";
    import { flattenTimeline } from "@src/ui/flatChatItems";
    import ChatEvent from "@src/desktop/features/chats/core/events/ChatEvent.svelte";
    import ChatEventList from "@src/desktop/features/chats/core/events/ChatEventList.svelte";
    import CryptoTransferBuilder from "@src/desktop/features/chats/core/CryptoTransferBuilder.svelte";
    import DropTarget from "@src/desktop/features/chats/core/DropTarget.svelte";
    import Footer from "@src/desktop/features/chats/core/Footer.svelte";
    import GiphySelector from "@src/desktop/features/chats/core/GiphySelector.svelte";
    import MemeBuilder from "@src/desktop/features/chats/core/MemeBuilder.svelte";
    import P2PSwapContentBuilder from "@src/desktop/features/chats/core/content/P2PSwapContentBuilder.svelte";
    import PollBuilder from "@src/desktop/features/chats/core/PollBuilder.svelte";
    import TimelineDate from "@src/desktop/features/chats/core/TimelineDate.svelte";
