<script lang="ts">
    ...
    import LinkButton from "@src/desktop/shared/LinkButton.svelte";
    import Translatable from "@src/ui/Translatable.svelte";
    import ChatMessage from "@src/desktop/features/chats/core/ChatMessage.svelte";
    import IntersectionObserverComponent from "@src/desktop/features/chats/core/IntersectionObserver.svelte";
