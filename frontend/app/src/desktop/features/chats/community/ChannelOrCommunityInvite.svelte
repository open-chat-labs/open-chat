<script lang="ts">
    ...
    import InviteUsersHeader from "@src/desktop/features/chats/group/InviteUsersHeader.svelte";
    import InviteUsersBody from "@src/desktop/features/chats/group/InviteUsersBody.svelte";
