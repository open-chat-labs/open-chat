<script lang="ts">
    ...
    import ReferredUsersList from "@src/desktop/features/profile/ReferredUsersList.svelte";
    import PermissionsViewer from "@src/desktop/features/chats/community/PermissionsViewer.svelte";
