<script lang="ts">
    ...
    import { uniquePersonGate } from "@src/utils/access";
    ...
    import Verified from "@src/desktop/ui/icons/Verified.svelte";
    ...
    import UsernameInput from "@src/desktop/shared/UsernameInput.svelte";
    import Stats from "@src/desktop/shared/Stats.svelte";
    import Expiry from "@src/desktop/features/upgrade/Expiry.svelte";
