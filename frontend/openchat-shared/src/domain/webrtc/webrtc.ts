...
const RemoteVideoCallStartedSchema = Type.Intersect([
    WebRtcMessageCommonSchema,
    Type.Object({
...
const RemoteVideoCallEndedSchema = Type.Intersect([
    WebRtcMessageCommonSchema,
    Type.Object({
...
const CurrentUserTypingSchema = Type.Intersect([
    WebRtcMessageCommonSchema,
    Type.Object({
...
const CurrentUserStoppedTypingSchema = Type.Intersect([
    WebRtcMessageCommonSchema,
    Type.Object({
...
const RemoteUserTypingSchema = Type.Intersect([
    WebRtcMessageCommonSchema,
    Type.Object({
...
const RemoteUserStoppedTypingSchema = Type.Intersect([
    WebRtcMessageCommonSchema,
    Type.Object({
...
const RemoteUserToggledReactionSchema = Type.Intersect([
    WebRtcMessageCommonSchema,
    Type.Object({
...
const RemoteUserRemovedMessageSchema = Type.Intersect([
    WebRtcMessageCommonSchema,
    Type.Object({
...
const RemoteUserDeletedMessageSchema = Type.Intersect([
    WebRtcMessageCommonSchema,
    Type.Object({
...
const RemoteUserUndeletedMessageSchema = Type.Intersect([
    WebRtcMessageCommonSchema,
    Type.Object({
...
const RemoteUserReadMessageSchema = Type.Intersect([
    WebRtcMessageCommonSchema,
    Type.Object({
