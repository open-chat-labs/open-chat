...
export function accessGateJson(json: TAccessGate): AccessGate {
    ...
    if ("SnsNeuron" in json) {
        return {
            ...
            governanceCanister: bytesToHexString(json.SnsNeuron.governance_canister_id),
        };
    }
    if ("VerifiedCredential" in json) {
        ...
        return {
            kind: "credential_gate",
            credential: {
                issuerCanisterId: bytesToHexString(json.VerifiedCredential.issuer_canister_id),
    ...
    if ("Payment" in json) {
        return {
            kind: "payment_gate",
            ledgerCanister: bytesToHexString(json.Payment.ledger_canister_id),
    ...
    if ("TokenBalance" in json) {
        return {
            kind: "token_balance_gate",
            ledgerCanister: bytesToHexString(json.TokenBalance.ledger_canister_id),
...
export function groupSubtypeJson(subtype: TGroupSubtype): GroupSubtype {
    return {
        kind: "governance_proposals",
        isNns: subtype.GovernanceProposals.is_nns,
        governanceCanisterId: bytesToHexString(subtype.GovernanceProposals.governance_canister_id),
    };
}
