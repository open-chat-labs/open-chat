...
export interface LastOnlineArgs { 'user_ids' : Array<UserId> }
export type LastOnlineResponse = {
    'Success' : Array<
      { 'user_id' : UserId, 'duration_since_last_online' : Milliseconds }
    >
  };
...
export interface _SERVICE {
  'last_online' : ActorMethod<[LastOnlineArgs], LastOnlineResponse>,
