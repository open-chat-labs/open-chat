...
export type DeleteFileFailureReason = { NotFound: null } | { NotAuthorized: null };
export type DeleteFileResponse = { NotFound: null } | { NotAuthorized: null } | { Success: null };
export interface DeleteFilesArgs {
    file_ids: Array<FileId>;
}
...
export type FileInfoResponse = { NotFound: null } | { Success: FileInfoSuccessResult };
