...
export interface AddGovernanceCanisterArgs {
  'name' : string,
  'description' : [] | [string],
  'governance_canister_id' : CanisterId,
  'avatar' : [] | [Avatar],
}
export type AddGovernanceCanisterResponse = { 'Success' : null } |
...
export interface RemoveGovernanceCanisterArgs {
  'governance_canister_id' : CanisterId,
  'delete_group' : boolean,
}
export type RemoveGovernanceCanisterResponse = { 'NotFound' : null } |
  { 'Success' : null } |
  { 'InternalError' : string };
...
export interface UpdateGroupDetailsArgs {
  'name' : [] | [string],
  'description' : [] | [string],
  'governance_canister_id' : CanisterId,
  'avatar' : AvatarUpdate,
}
export type UpdateGroupDetailsResponse = { 'DescriptionTooLong' : null } |
  { 'NameTooShort' : null } |
  { 'NotFound' : null } |
  { 'NotAuthorized' : null } |
  { 'AvatarTooBig' : null } |
