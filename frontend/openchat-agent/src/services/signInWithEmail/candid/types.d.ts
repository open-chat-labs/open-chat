...
export type GetDelegationResponse = { NotFound: null } | { Success: SignedDelegation };
...
export type InitOrUpgradeArgs = { Upgrade: UpgradeArgs } | { Init: InitArgs };
...
export interface _SERVICE {
    generate_magic_link: ActorMethod<[GenerateMagicLinkArgs], GenerateMagicLinkResponse>;
