...
export interface MakeChannelPrivateArgs {
    channel_id: ChannelId;
}
...
export type RemoveMemberFromChannelResponse =
    | { UserNotInChannel: null }
    | { ChannelNotFound: null }
    | { NotAuthorized: null }
    | { Success: null }
...
export type RulesResponse = { NotAuthorized: null } | { Success: { rules: [] | [string] } };
...
export type SearchChannelResponse =
    ...
    | { TermTooLong: number }
    | { InvalidTerm: null };
export interface SelectedChannelInitialArgs {
    channel_id: ChannelId;
}
...
export type ToggleMuteNotificationsResponse =
    | { Success: null }
    | { UserNotInCommunity: null }
    | { UserSuspended: null }
    | { CommunityFrozen: null };
...
export interface _SERVICE {
    add_members_to_channel: ActorMethod<[AddMembersToChannelArgs], AddMembersToChannelResponse>;
    add_reaction: ActorMethod<[AddReactionArgs], AddReactionResponse>;
    block_user: ActorMethod<[BlockUserArgs], BlockUserResponse>;
    change_channel_role: ActorMethod<[ChangeChannelRoleArgs], ChangeChannelRoleResponse>;
    ...
    decline_invitation: ActorMethod<[DeclineInvitationArgs], DeclineInvitationResponse>;
    ...
    make_channel_private: ActorMethod<[MakeChannelPrivateArgs], MakeChannelPrivateResponse>;
    ...
    update_community: ActorMethod<[UpdateCommunityArgs], UpdateCommunityResponse>;
}
