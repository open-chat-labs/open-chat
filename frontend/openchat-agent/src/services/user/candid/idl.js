export const idlFactory = ({ IDL }) => {
    ...
    return IDL.Service({
        ...
        create_community: IDL.Func([CreateCommunityArgs], [CreateCommunityResponse], []),
        create_group: IDL.Func([CreateGroupArgs], [CreateGroupResponse], []),
        delete_community: IDL.Func([DeleteCommunityArgs], [DeleteCommunityResponse], []),
        delete_group: IDL.Func([DeleteGroupArgs], [DeleteGroupResponse], []),
        delete_messages: IDL.Func([DeleteMessagesArgs], [DeleteMessagesResponse], []),
        deleted_message: IDL.Func([DeletedMessageArgs], [DeletedMessageResponse], ["query"]),
        edit_message_v2: IDL.Func([EditMessageV2Args], [EditMessageResponse], []),
        events: IDL.Func([EventsArgs], [EventsResponse], ["query"]),
        events_by_index: IDL.Func([EventsByIndexArgs], [EventsResponse], ["query"]),
        ...
        initial_state: IDL.Func([InitialStateArgs], [InitialStateResponse], ["query"]),
        leave_community: IDL.Func([LeaveCommunityArgs], [LeaveCommunityResponse], []),
        ...
        mute_notifications: IDL.Func([MuteNotificationsArgs], [MuteNotificationsResponse], []),
        pin_chat_v2: IDL.Func([PinChatV2Request], [PinChatV2Response], []),
        public_profile: IDL.Func([PublicProfileArgs], [PublicProfileResponse], ["query"]),
        remove_reaction: IDL.Func([RemoveReactionArgs], [RemoveReactionResponse], []),
        search_messages: IDL.Func([SearchMessagesArgs], [SearchMessagesResponse], ["query"]),
        send_message_v2: IDL.Func([SendMessageV2Args], [SendMessageResponse], []),
        ...
        undelete_messages: IDL.Func([UndeleteMessagesArgs], [UndeleteMessagesResponse], []),
        ...
        withdraw_crypto_v2: IDL.Func([WithdrawCryptoArgs], [WithdrawCryptoResponse], []),
    });
};
