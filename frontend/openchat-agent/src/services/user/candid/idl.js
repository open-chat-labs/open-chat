export const idlFactory = ({ IDL }) => {
  ...
  const ICRC2_ApproveError = IDL.Variant({
  ...
  const Achievement = IDL.Variant({
    ...
    'FavouritedChat' : IDL.Null,
    'AppointedGroupAdmin' : IDL.Null,
    'HadMessageReactedTo' : IDL.Null,
    'VotedOnPoll' : IDL.Null,
    'ChosenAsGroupAdmin' : IDL.Null,
    'OwnGroupWithOneHundredDiamondMembers' : IDL.Null,
    'JoinedCommunity' : IDL.Null,
    'SetCommunityDisplayName' : IDL.Null,
    ...
    'Streak14' : IDL.Null,
    'Streak30' : IDL.Null,
    'HadMessageTipped' : IDL.Null,
    'SwappedFromWallet' : IDL.Null,
    'EditedMessage' : IDL.Null,
    'SentGroupMessage' : IDL.Null,
    ...
    'SentImage' : IDL.Null,
    'EnabledDisappearingMessages' : IDL.Null,
    'ForwardedMessage' : IDL.Null,
    'SentPrize' : IDL.Null,
    'FollowedThread' : IDL.Null,
    'SetBio' : IDL.Null,
    'SentChannelMessage' : IDL.Null,
    ...
    'DirectChats20' : IDL.Null,
    'SetGroupAccessGate' : IDL.Null,
    'SentFile' : IDL.Null,
    'SentDirectMessage' : IDL.Null,
    'SentMeme' : IDL.Null,
    'SentPoll' : IDL.Null,
    'SentAudio' : IDL.Null,
    'SuggestedTranslation' : IDL.Null,
    'SetAvatar' : IDL.Null,
    'SentVideo' : IDL.Null,
  });
