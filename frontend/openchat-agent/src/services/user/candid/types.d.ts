...
export type BlockUserResponse = { Success: null } | { UserSuspended: null };
...
export interface CancelMessageReminderArgs {
    reminder_id: bigint;
}
...
export interface CreateCommunitySuccessResult {
    community_id: CommunityId;
}
...
export type DeleteCommunityResponse =
    | { NotAuthorized: null }
    | { Success: null }
    | { UserSuspended: null }
...
export type DeletedMessageResponse =
    | { MessageNotFound: null }
    | { ChatNotFound: null }
    | { NotAuthorized: null }
...
export interface InitUserPrincipalMigrationArgs {
...
export type LeaveCommunityResponse =
...
export type ManageFavouriteChatsResponse = { Success: null } | { UserSuspended: null };
...
export interface PinChatV2Request {
    chat: ChatInList;
}
export type PinChatV2Response = { ChatNotFound: null } | { Success: null };
...
export type SetAvatarResponse =
    ...
    | { Success: null }
    | { UserSuspended: null };
export interface SetBioArgs {
    text: string;
}
export type SetBioResponse =
...
export interface SetContactArgs {
    contact: OptionalContact;
}
export type SetContactResponse =
    | { NoChange: null }
...
export type UnblockUserResponse = { Success: null } | { UserSuspended: null };
...
export type UndeleteMessagesResponse =
    | { ChatNotFound: null }
...
export type UnmuteNotificationsResponse =
    | { ChatNotFound: null }
    | { Success: null }
    | { InternalError: string };
export interface UnpinChatV2Request {
    chat: ChatInList;
}
export type UnpinChatV2Response = { ChatNotFound: null } | { Success: null };
...
export interface _SERVICE {
    ...
    create_community: ActorMethod<[CreateCommunityArgs], CreateCommunityResponse>;
    create_group: ActorMethod<[CreateGroupArgs], CreateGroupResponse>;
    delete_community: ActorMethod<[DeleteCommunityArgs], DeleteCommunityResponse>;
    ...
    hot_group_exclusions: ActorMethod<[HotGroupExclusionsArgs], HotGroupExclusionsResponse>;
    ...
    manage_favourite_chats: ActorMethod<[ManageFavouriteChatsArgs], ManageFavouriteChatsResponse>;
    mark_read: ActorMethod<[MarkReadArgs], MarkReadResponse>;
    messages_by_message_index: ActorMethod<
        [MessagesByMessageIndexArgs],
        MessagesByMessageIndexResponse
    >;
    migrate_user_principal: ActorMethod<[MigrateUserPrincipalArgs], MigrateUserPrincipalResponse>;
    mute_notifications: ActorMethod<[MuteNotificationsArgs], MuteNotificationsResponse>;
    ...
    set_community_indexes: ActorMethod<[SetCommunityIndexesArgs], SetCommunityIndexesResponse>;
    set_contact: ActorMethod<[SetContactArgs], SetContactResponse>;
    set_message_reminder_v2: ActorMethod<[SetMessageReminderV2Args], SetMessageReminderResponse>;
    unblock_user: ActorMethod<[UnblockUserArgs], UnblockUserResponse>;
    undelete_messages: ActorMethod<[UndeleteMessagesArgs], UndeleteMessagesResponse>;
    unmute_notifications: ActorMethod<[UnmuteNotificationsArgs], UnmuteNotificationsResponse>;
    unpin_chat_v2: ActorMethod<[UnpinChatV2Request], UnpinChatV2Response>;
    updates: ActorMethod<[UpdatesArgs], UpdatesResponse>;
    withdraw_crypto_v2: ActorMethod<[WithdrawCryptoArgs], WithdrawCryptoResponse>;
}
