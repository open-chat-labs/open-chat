import type { TranslationCorrection } from "openchat-shared";
...
export function applyTranslationCorrection(correction: TranslationCorrection): void {
    addMessages(correction.locale, toLocaleDictionary({ [correction.key]: correction }));
}
 ...
 */
function toLocaleDictionary(byLocale: Record<string, TranslationCorrection>): LocaleDictionary {
