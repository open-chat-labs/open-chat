...
export class Colours {
    ...
    cssVariables(): CssVariable[] {
        return [
            ...
            this.background0.cssVariable("background0"),
            this.background1.cssVariable("background1"),
            this.background2.cssVariable("background2"),
            this.disabledButton.cssVariable("disabledButton"),
            this.primaryMuted.cssVariable("primaryMuted"),
            this.textPrimary.cssVariable("textPrimary"),
            this.textSecondary.cssVariable("textSecondary"),
            this.textTertiary.cssVariable("textTertiary"),
            this.textPlaceholder.cssVariable("textPlaceholder"),
            this.textOnPrimary.cssVariable("textOnPrimary"),
            this.primaryGradient.cssVariable("primaryGradient"),
            this.primaryGradientInverted.cssVariable("primaryGradientInverted"),
        ];
    }
}
