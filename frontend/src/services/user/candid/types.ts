...
export type PinChatResponse = { Success: null } | { PinnedLimitReached: number };
...
export type SetAvatarResponse = { AvatarTooBig: FieldTooLongResult } | { Success: null };
export interface SetBioArgs {
    text: string;
}
export type SetBioResponse = { TooLong: FieldTooLongResult } | { Success: null };
...
export type TransferCryptoWithinGroupResponse =
    | { TextTooLong: number }
...
export interface _SERVICE {
    ...
    public_profile: (arg_0: PublicProfileArgs) => Promise<PublicProfileResponse>;
    recommended_groups: (arg_0: RecommendedGroupsArgs) => Promise<RecommendedGroupsResponse>;
    ...
    vote_on_proposal: (arg_0: VoteOnProposalArgs) => Promise<VoteOnProposalResponse>;
    withdraw_crypto: (arg_0: WithdrawCryptoRequest) => Promise<WithdrawCryptoResponse>;
}
