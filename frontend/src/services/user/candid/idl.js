export const idlFactory = ({ IDL }) => {
    ...
    return IDL.Service({
        ...
        register_poll_vote: IDL.Func([RegisterPollVoteArgs], [RegisterPollVoteResponse], []),
        ...
        toggle_reaction: IDL.Func([ToggleReactionArgs], [ToggleReactionResponse], []),
        ...
        vote_on_proposal: IDL.Func([VoteOnProposalArgs], [VoteOnProposalResponse], []),
        withdraw_crypto: IDL.Func([WithdrawCryptoRequest], [WithdrawCryptoResponse], []),
    });
};
