...
export type PushSubscriptionResponse = { Success: null } | { InternalError: string };
export type RegistrationFee = { ICP: ICPRegistrationFee } | { Cycles: CyclesRegistrationFee };
export interface RemoveSubscriptionArgs {
    p256dh_key: string;
}
...
export interface _SERVICE {
    push_subscription: (arg_0: PushSubscriptionArgs) => Promise<PushSubscriptionResponse>;
    remove_subscription: (arg_0: RemoveSubscriptionArgs) => Promise<RemoveSubscriptionResponse>;
    remove_subscriptions_for_user: (
        arg_0: RemoveSubscriptionsForUserArgs
    ) => Promise<RemoveSubscriptionsForUserResponse>;
    subscription_exists: (arg_0: SubscriptionExistsArgs) => Promise<SubscriptionExistsResponse>;
}
