...
export type DisableInviteCodeResponse = { NotAuthorized: null } | { Success: null };
...
export type EnableInviteCodeResponse = { NotAuthorized: null } | { Success: { code: bigint } };
...
export type InviteCodeResponse = { NotAuthorized: null } | { Success: { code: [] | [bigint] } };
export type MakePrivateArgs = {};
export type MakePrivateResponse =
    | { NotAuthorized: null }
    | { Success: null }
    | { AlreadyPrivate: null }
    | { InternalError: null };
...
export interface PublicSummaryArgs {
    invite_code: [] | [bigint];
}
export type PublicSummaryResponse = { NotAuthorized: null } | { Success: PublicSummarySuccess };
export interface PublicSummarySuccess {
...
export type ResetInviteCodeResponse = { NotAuthorized: null } | { Success: { code: bigint } };
export type Role =
    | { Participant: null }
...
export interface _SERVICE {
    ...
    disable_invite_code: (arg_0: DisableInviteCodeArgs) => Promise<DisableInviteCodeResponse>;
    edit_message: (arg_0: EditMessageArgs) => Promise<EditMessageResponse>;
    enable_invite_code: (arg_0: EnableInviteCodeArgs) => Promise<EnableInviteCodeResponse>;
    ...
    messages_by_message_index: (
        arg_0: MessagesByMessageIndexArgs
    ) => Promise<MessagesByMessageIndexResponse>;
    pin_message: (arg_0: PinMessageArgs) => Promise<PinMessageResponse>;
    public_summary: (arg_0: PublicSummaryArgs) => Promise<PublicSummaryResponse>;
    register_poll_vote: (arg_0: RegisterPollVoteArgs) => Promise<RegisterPollVoteResponse>;
    remove_participant: (arg_0: RemoveParticipantArgs) => Promise<RemoveParticipantResponse>;
    reset_invite_code: (arg_0: ResetInviteCodeArgs) => Promise<ResetInviteCodeResponse>;
    ...
    thread_previews: (arg_0: ThreadPreviewsArgs) => Promise<ThreadPreviewsResponse>;
    ...
    update_permissions: (arg_0: UpdatePermissionsArgs) => Promise<UpdatePermissionsResponse>;
}
