...
export interface AddSuperAdminArgs {
    user_id: UserId;
}
export type AddSuperAdminResponse =
    | { Success: null }
...
export interface ConfirmPhoneNumberArgs {
...
export type CreateChallengeResponse = { Throttled: null } | { Success: Challenge };
export type CryptoAccount = { Mint: null } | { User: UserId } | { Account: AccountIdentifier };
export type CryptoAccountFull =
...
export interface RemoveSuperAdminArgs {
    user_id: UserId;
}
export type RemoveSuperAdminResponse =
    | { Success: null }
    | { NotSuperAdmin: null }
    | { InternalError: string };
...
export type SetUsernameResponse =
    ...
    | { Success: null }
    | { UserNotFound: null };
export interface SubmitPhoneNumberArgs {
...
export interface UpgradeStorageArgs {
...
export interface _SERVICE {
    add_super_admin: (arg_0: AddSuperAdminArgs) => Promise<AddSuperAdminResponse>;
    check_username: (arg_0: CheckUsernameArgs) => Promise<CheckUsernameResponse>;
    confirm_phone_number: (arg_0: ConfirmPhoneNumberArgs) => Promise<ConfirmPhoneNumberResponse>;
    create_challenge: (arg_0: CreateChallengeArgs) => Promise<CreateChallengeResponse>;
    ...
    remove_super_admin: (arg_0: RemoveSuperAdminArgs) => Promise<RemoveSuperAdminResponse>;
    ...
    submit_phone_number: (arg_0: SubmitPhoneNumberArgs) => Promise<SubmitPhoneNumberResponse>;
    super_admins: (arg_0: SuperAdminsArgs) => Promise<SuperAdminsResponse>;
    upgrade_storage: (arg_0: UpgradeStorageArgs) => Promise<UpgradeStorageResponse>;
