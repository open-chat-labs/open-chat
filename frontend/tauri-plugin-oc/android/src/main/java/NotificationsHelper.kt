...
object NotificationsHelper {
    ...
    fun createNotificationChannel(context: Context) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            val importance = NotificationManager.IMPORTANCE_HIGH // Or IMPORTANCE_DEFAULT, IMPORTANCE_LOW, etc. HIGH enables banners.
    ...
    fun getFCMToken() {
        FirebaseMessaging.getInstance().token.addOnCompleteListener { task ->
            ...
            // Log or send this token to your backend
            println("TEST_OC: FCM Token: $token")
