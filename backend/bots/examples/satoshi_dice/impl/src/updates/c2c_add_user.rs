...
fn welcome_messages() -> Vec<MessageContentInitial> {
    Vec::from_iter([
...
fn to_text_content(str: &str) -> MessageContentInitial {
    MessageContentInitial::Text(TextContent { text: str.to_string() })
}
