...
impl ChatMetricsInternal {
    ...
    pub fn hydrate(&self) -> ChatMetrics {
        ChatMetrics {
            text_messages: self.get(MetricKey::TextMessages),
            image_messages: self.get(MetricKey::ImageMessages),
            video_messages: self.get(MetricKey::VideoMessages),
            audio_messages: self.get(MetricKey::AudioMessages),
            file_messages: self.get(MetricKey::FileMessages),
            polls: self.get(MetricKey::Polls),
            poll_votes: self.get(MetricKey::PollVotes),
            crypto_messages: self.get(MetricKey::CryptoMessages),
            deleted_messages: self.get(MetricKey::DeletedMessages),
            giphy_messages: self.get(MetricKey::GiphyMessages),
            prize_messages: self.get(MetricKey::PrizeMessages),
            prize_winner_messages: self.get(MetricKey::PrizeWinnerMessages),
            replies: self.get(MetricKey::Replies),
            edits: self.get(MetricKey::Edits),
            reactions: self.get(MetricKey::Reactions),
            proposals: self.get(MetricKey::Proposals),
            reported_messages: self.get(MetricKey::ReportedMessages),
            message_reminders: self.get(MetricKey::MessageReminders),
            custom_type_messages: self.get(MetricKey::CustomTypeMessages),
