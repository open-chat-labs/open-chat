...
use types::{
    AvatarChanged, ChatMetrics, Cryptocurrency, DeletedBy, DirectChatCreated, EventsTimeToLiveUpdated, GroupCreated,
    GroupDescriptionChanged, GroupFrozen, GroupGateUpdated, GroupInviteCodeChanged, GroupNameChanged, GroupRulesChanged,
    GroupUnfrozen, GroupVisibilityChanged, MemberJoined, MemberLeft, MembersAdded, MembersRemoved, Message, MessageContent,
    MessageContentInternal, MessageId, MessageIndex, MessagePinned, MessageUnpinned, OwnershipTransferred,
    ParticipantAssumesSuperAdmin, ParticipantDismissedAsSuperAdmin, ParticipantRelinquishesSuperAdmin, PermissionsChanged,
    PollVoteRegistered, Reaction, ReplyContext, RoleChanged, ThreadSummary, TimestampMillis, UserId, UsersBlocked,
