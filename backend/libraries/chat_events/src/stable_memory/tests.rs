...
use crate::stable_memory::tests::test_values::{
    AUDIO_CURRENT, AUDIO_PREV1, AUDIO_PREV2, CRYPTO_CURRENT, CRYPTO_PREV1, CRYPTO_PREV2, CRYPTO_PREV3, CUSTOM_CURRENT,
    CUSTOM_PREV1, CUSTOM_PREV2, DELETED_CURRENT, DELETED_PREV1, DELETED_PREV2, FILE_CURRENT, FILE_PREV1, FILE_PREV2,
    GIPHY_CURRENT, GIPHY_PREV1, GIPHY_PREV2, GOVERNANCE_PROPOSAL_CURRENT, GOVERNANCE_PROPOSAL_PREV1, GOVERNANCE_PROPOSAL_PREV2,
    IMAGE_CURRENT, IMAGE_PREV1, IMAGE_PREV2, MESSAGE_REMINDER_CREATED_CURRENT, MESSAGE_REMINDER_CREATED_PREV1,
    MESSAGE_REMINDER_CREATED_PREV2, MESSAGE_REMINDER_CURRENT, MESSAGE_REMINDER_PREV1, MESSAGE_REMINDER_PREV2, P2P_SWAP_CURRENT,
    P2P_SWAP_PREV1, P2P_SWAP_PREV2, P2P_SWAP_PREV3, POLL_CURRENT, POLL_PREV1, POLL_PREV2, PRIZE_CURRENT, PRIZE_PREV1,
    PRIZE_PREV2, PRIZE_PREV3, PRIZE_PREV4, PRIZE_WINNER_CURRENT, PRIZE_WINNER_PREV1, PRIZE_WINNER_PREV2,
    REPORTED_MESSAGE_CURRENT, REPORTED_MESSAGE_PREV1, REPORTED_MESSAGE_PREV2, TEXT_CURRENT, TEXT_PREV1, TEXT_PREV2,
    VIDEO_CALL_CURRENT, VIDEO_CALL_PREV1, VIDEO_CALL_PREV2, VIDEO_CURRENT, VIDEO_PREV1, VIDEO_PREV2,
};
...
fn prize_content() {
    ...
    for test in [PRIZE_CURRENT, PRIZE_PREV1, PRIZE_PREV2, PRIZE_PREV3, PRIZE_PREV4] {
