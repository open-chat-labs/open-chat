...
use user_canister::{
    ...
    deleted_message, edit_message_v2, events, events_by_index, events_window, initial_state, manage_favourite_chats, mark_read,
    messages_by_message_index, mute_notifications, pin_chat_v2, public_profile, remove_reaction, send_message_v2, set_avatar,
    set_bio, set_contact, set_profile_background, unblock_user, undelete_messages, unmute_notifications, unpin_chat_v2,
    updates,
};
