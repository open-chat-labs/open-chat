...
use user_canister::{
    add_hot_group_exclusions, add_reaction, archive_unarchive_chats, bio, block_user, c2c_bot_chat_summary, c2c_install_bot,
    c2c_pay_for_premium_item, c2c_uninstall_bot, cancel_message_reminder, chit_events, claim_daily_chit, configure_wallet,
    contacts, delete_direct_chat, delete_messages, delete_saved_crypto_account, deleted_message, edit_message_v2, events,
    events_by_index, events_window, hot_group_exclusions, initial_state, local_user_index, manage_favourite_chats,
    mark_achievements_seen, mark_message_activity_feed_read, mark_read, message_activity_feed, messages_by_message_index,
    mute_notifications, pay_for_streak_insurance, pin_chat_v2, public_profile, remove_reaction, report_message,
