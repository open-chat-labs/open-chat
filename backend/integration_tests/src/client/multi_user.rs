...
use user_canister::{
    ...
    c2c_charge_user_account, c2c_install_bot, c2c_pay_for_premium_item, c2c_uninstall_bot, cancel_message_reminder,
    chit_events, claim_daily_chit, configure_wallet, contacts, delete_direct_chat, delete_messages,
    ...
    saved_crypto_accounts, search_messages, set_avatar, set_bio, set_contact, set_message_reminder_v2, set_pin_number,
