...
use types::{
    ...
    Empty, EventsResponse, Message, MessageContent, MessageContentInitial, MessageId, MessageIndex, OptionUpdate,
...
use user_canister::{ChatInList, NamedAccount, WalletConfig};
