...
fn next_batch(runtime_state: &mut RuntimeState) -> Option<Vec<(CanisterId, Vec<NotificationsIndexEvent>)>> {
    runtime_state.data.notifications_index_event_sync_queue.try_start_batch()
}
