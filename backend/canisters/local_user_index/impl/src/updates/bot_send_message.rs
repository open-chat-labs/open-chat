...
async fn send_message_to_channel(
    ...
    .await
    {
        Ok(response) => match response {
            ...
            community_canister::c2c_bot_send_message::Response::Error(code, message) => Error(code, message),
...
async fn send_message_to_group(
    ...
    .await
    {
        Ok(response) => match response {
            ...
            group_canister::c2c_bot_send_message::Response::Error(code, message) => Error(code, message),
...
async fn send_message_to_user(
    ...
    .await
    {
        Ok(response) => match response {
            ...
            user_canister::c2c_bot_send_message::Response::Error(code, message) => Error(code, message),
