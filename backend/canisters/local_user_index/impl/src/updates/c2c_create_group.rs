...
fn prepare(args: Args, state: &mut RuntimeState) -> Result<PrepareOk, Response> {
    ...
    let init_canister_args = group_canister::init::Args {
        ...
        created_by_user_type: if args.created_by_user_id == state.data.proposals_bot_canister_id.into() {
        ...
        local_group_index_canister_id: state.data.local_group_index_canister_id,
