...
use types::{AutonomousConfig, BotCommandDefinition, BotDefinition, BotInstallationLocation, BotRegistrationState, UserId};
    ...
    pub fn add(
        ...
        self.bots.insert(
            ...
            Bot {
                ...
                registration_state: BotRegistrationState::Private(initial_install_location),
            },
        );
