...
- Send `c2c_bot_send_message` for a direct chat to the canister holding the user, rather than to their user id, which for a user in a MultiUser canister is not a canister id ([#PRNUM](https://github.com/open-chat-labs/open-chat/pull/PRNUM))
