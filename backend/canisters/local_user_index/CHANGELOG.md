...
- Add `c2c_multi_user_canister`, the MultiUser canister's counterpart to `c2c_user_canister`, taking events which each name the user they are from, who must be hosted by the calling canister ([#TODO](https://github.com/open-chat-labs/open-chat/pull/TODO))
