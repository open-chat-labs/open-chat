...
- Pass `UserIdMigrated` on to each of the listed groups and communities which this LocalUserIndex controls. The groups and communities must be upgraded first
