...
- Track every MultiUser canister, learnt from the registrations of their users and from creating local ones, and record when each local MultiUser canister was created and how many users it holds ([#9460](https://github.com/open-chat-labs/open-chat/pull/9460))
