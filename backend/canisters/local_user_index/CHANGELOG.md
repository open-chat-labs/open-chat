...
- Add `is_user_or_multi_user_canister` so User and MultiUser canisters can authenticate callers via their LocalUserIndex rather than a cross-subnet call to the UserIndex ([#9461](https://github.com/open-chat-labs/open-chat/pull/9461))
