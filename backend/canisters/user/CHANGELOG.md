...
- Send events to the LocalUserIndex over `c2c_user_canister_v2`, the endpoint the MultiUser canister also uses, rather than `c2c_user_canister` ([#TODO](https://github.com/open-chat-labs/open-chat/pull/TODO))
