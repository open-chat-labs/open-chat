...
## [[2.0.676](https://github.com/open-ic/open-chat/releases/tag/v2.0.676-user)] - TBD
...
- Remove all but one OpenChatBot welcome message ([#3478](https://github.com/open-ic/open-chat/pull/3478))
