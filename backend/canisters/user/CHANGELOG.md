...
- Move the PIN number, hot group exclusions and saved crypto accounts models into the shared `user_state` library, so the MultiUser canister can hold them per user ([#TODO](https://github.com/open-chat-labs/open-chat/pull/TODO))
