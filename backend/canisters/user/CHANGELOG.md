...
- Assign a `key_id` to every existing direct chat and move its events to the `key_id` based stable memory keys, then remove the legacy key types ([#9391](https://github.com/open-chat-labs/open-chat/pull/9391))
