...
- Move the game CHIT keys model and `c2c_game_chit` argument validation into the `user_state` library, shared with the MultiUser canister ([#TODO](https://github.com/open-chat-labs/open-chat/pull/TODO))
