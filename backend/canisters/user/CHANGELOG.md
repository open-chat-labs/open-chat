...
- Move how far the user has read each thread in each group and channel from the heap into the stable memory map for small entries ([#XXXX](https://github.com/open-chat-labs/open-chat/pull/XXXX))
