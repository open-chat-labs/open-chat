...
- Move the message activity feed events from the heap into the stable memory map for small entries ([#XXXX](https://github.com/open-chat-labs/open-chat/pull/XXXX))
