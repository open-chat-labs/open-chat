...
- Share the checks and handling of `c2c_bot_send_message` with the MultiUser canister via `user_core` ([#PRNUM](https://github.com/open-chat-labs/open-chat/pull/PRNUM))
