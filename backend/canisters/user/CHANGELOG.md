...
- Add a `frozen` state, which rejects every update call while set and leaves queries unaffected. Nothing sets it yet ([#PR](https://github.com/open-chat-labs/open-chat/pull/PR))
