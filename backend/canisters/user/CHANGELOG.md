...
- Skip the regular jobs while frozen, while still flushing any events queued by updates which run while frozen ([#9548](https://github.com/open-chat-labs/open-chat/pull/9548))
