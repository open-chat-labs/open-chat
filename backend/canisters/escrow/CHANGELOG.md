...
- Pass `user_to_notify` through to `SwapStatusChange` so that a canister hosting multiple users knows which user a swap belongs to ([#XXXX](https://github.com/open-chat-labs/open-chat/pull/XXXX))
