...
fn main() {
    generate_candid_method!(user_index, action_signing_keys, query);
    generate_candid_method!(user_index, ai_apps, query);
    generate_candid_method!(user_index, ai_apps_by_ids, query);
    ...
    generate_candid_method!(user_index, my_ai_apps, query);
    ...
    generate_candid_method!(user_index, remove_ai_app, update);
    generate_candid_method!(user_index, remove_bot, update);
    generate_candid_method!(user_index, stage_action_signing_key, update);
    ...
    generate_ts_method!(user_index, action_signing_keys);
    generate_ts_method!(user_index, bot_installation_events);
    ...
    generate_ts_method!(user_index, my_ai_apps);
    ...
    generate_ts_method!(user_index, remove_ai_app);
    ...
    generate_ts_method!(user_index, stage_action_signing_key);
