...
- Make `create_multi_user_canister` callable by platform operators rather than via proposal, and only via msgpack ([#9569](https://github.com/open-chat-labs/open-chat/pull/9569))
