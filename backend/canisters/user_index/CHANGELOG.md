...
- Include in `UserIdMigrated` the groups and communities the migrated user is in, for the LocalUserIndexes to notify. The LocalUserIndexes must be upgraded first
