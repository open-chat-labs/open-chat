...
- Make `set_multi_user_canisters_enabled` callable by platform operators rather than the governance principal ([#9574](https://github.com/open-chat-labs/open-chat/pull/9574))
