...
use local_user_index_canister::{PlatformModeratorStatusChanged, UserIndexToLocalUserIndexEvent};
use types::UserId;
...
fn commit(user_id: UserId, state: &mut RuntimeState) {
    ...
    state.push_event_to_all_local_user_indexes(
        UserIndexToLocalUserIndexEvent::SuperAdminStatusChanged(PlatformModeratorStatusChanged {
            user_id,
