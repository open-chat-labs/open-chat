...
fn main() {
    ...
    generate_candid_method!(identity, get_webauthn_delegation, query);

    generate_candid_method!(identity, approve_identity_link, update);
    generate_candid_method!(identity, create_identity, update);
    generate_candid_method!(identity, create_webauthn_identity, update);
    ...
    generate_candid_method!(identity, prepare_webauthn_delegation, update);
