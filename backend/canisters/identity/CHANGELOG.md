...
- Implement `get_account_linking_code` returns existing account linking code ([8358](https://github.com/open-chat-labs/open-chat/pull/8358))
...
- Implement `verify_account_linking_code` runs query to verify existence of the provided code ([8358](https://github.com/open-chat-labs/open-chat/pull/8358))
