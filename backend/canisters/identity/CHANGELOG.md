...
- Validate WebAuthn keys at registration and reject any the IC would not accept ([#PR_NUMBER](https://github.com/open-chat-labs/open-chat/pull/PR_NUMBER))
...
- Implement `create_account_linking_code` creates new account linking code, returns existing one if valid ([8358](https://github.com/open-chat-labs/open-chat/pull/8358))
- Implement `verify_account_linking_code` to verify account linking codes and link with temp principal ([8411](https://github.com/open-chat-labs/open-chat/pull/8411))
- Implement `finalise_account_linking_with_code` to link new principal with existing account ([8411](https://github.com/open-chat-labs/open-chat/pull/8411))
...
- Expose MessagePack versions of canister endpoints ([#7830](https://github.com/open-chat-labs/open-chat/pull/7830))
- Consolidate certificate verification logic + simplify responses ([#7831](https://github.com/open-chat-labs/open-chat/pull/7831))

## [[2.0.1655](https://github.com/open-chat-labs/open-chat/releases/tag/v2.0.1655-identity)] - 2025-03-17

### Added

- Support looking up which auth providers a user has linked ([#7603](https://github.com/open-chat-labs/open-chat/pull/7603))

### Changed

- Log total instructions consumed at end of upgrade ([#7551](https://github.com/open-chat-labs/open-chat/pull/7551))

## [[2.0.1608](https://github.com/open-chat-labs/open-chat/releases/tag/v2.0.1608-identity)] - 2025-02-17
