...
- Accept the sender in `c2c_send_message` and `c2c_tip_message` from a MultiUser canister acting for one of its users ([#9496](https://github.com/open-chat-labs/open-chat/pull/9496))
