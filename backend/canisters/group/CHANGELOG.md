...
- Tell a member's canister of each P2P swap they create directly in the group, so it is recorded against them ([#PRNUM](https://github.com/open-chat-labs/open-chat/pull/PRNUM))
