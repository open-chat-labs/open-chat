...
- Return an error from `register_proposal_vote` for users in MultiUser canisters, which can't vote via their canister and use `register_proposal_vote_v2` instead ([#PR](https://github.com/open-chat-labs/open-chat/pull/PR))
