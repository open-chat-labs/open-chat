...
- When a bot finalised a message, its `suppressed` and `@everyone` flags were swapped, so suppressed messages notified everyone and `@everyone` messages notified no one ([#9573](https://github.com/open-chat-labs/open-chat/pull/9573))
