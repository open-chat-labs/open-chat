...
- Split common group logic into new `group_chat_core` library ([#3620](https://github.com/open-ic/open-chat/pull/3620)), ([#3622](https://github.com/open-ic/open-chat/pull/3622)), ([#3624](https://github.com/open-ic/open-chat/pull/3624)), ([#3626](https://github.com/open-ic/open-chat/pull/3626)), ([#3633](https://github.com/open-ic/open-chat/pull/3633))
