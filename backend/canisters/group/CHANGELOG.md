...
- When told by the LocalUserIndex that a member has been migrated to a MultiUser canister, move their membership, role, invitation, block and other per-user state over to their new id, and map their principal to it
