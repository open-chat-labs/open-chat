...
use group_index_canister::set_max_concurrent_community_canister_upgrades::{Response::*, *};
use tracing::info;

// dfx --identity openchat canister --network ic call group_index set_max_concurrent_community_canister_upgrades '(record { value=N:nat32 })'
