...
- Add `c2c_group_canister_v2`, `c2c_community_canister_v2` and `c2c_local_user_index_v2`, which take each event paired with the user it is for, so that one call can carry the events for many users ([#9452](https://github.com/open-chat-labs/open-chat/pull/9452))
