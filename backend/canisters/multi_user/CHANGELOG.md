...
- Rename the `caller_is_owner` guards to `caller_is_hosted_user`, since the canister hosts many users ([#TODO](https://github.com/open-chat-labs/open-chat/pull/TODO))
