...
- Add the `Users` collection and per-user `User` state, `c2c_create_user` for the LocalUserIndex to add a user, and implement `bio` ([#PR](https://github.com/open-chat-labs/open-chat/pull/PR))
...
- Take the GroupIndex, Identity and Escrow canister ids and the video call operators in the init args, and include the user count in the metrics ([#PR](https://github.com/open-chat-labs/open-chat/pull/PR))
