...
- Add an unimplemented stub for every User canister endpoint, sharing the User canister's API types ([#XXXX](https://github.com/open-chat-labs/open-chat/pull/XXXX))
