...
- Send events to the LocalUserIndex over a queue, each naming the user it is from: notifications of direct messages, and blocking, unblocking and setting a profile background ([#TODO](https://github.com/open-chat-labs/open-chat/pull/TODO))
