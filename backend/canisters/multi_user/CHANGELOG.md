...
- Implement `pay_for_streak_insurance`, paying from the user's subaccount of the canister or an approved account, and the per-user job which uses up a day of streak insurance or resets it when a streak ends ([#TODO](https://github.com/open-chat-labs/open-chat/pull/TODO))
