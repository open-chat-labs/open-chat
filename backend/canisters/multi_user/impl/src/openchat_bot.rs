...
use types::{
    DirectChatUserNotificationPayload, DirectMessageNotification, EventWrapper, Message, SuspensionDuration, User, UserId,
    UserType,
};
...
// Pushes a message from the OpenChat bot to the chat with it of the user at `user_index`
...
// As the User canister's message of the same name, for the user at `user_index`
