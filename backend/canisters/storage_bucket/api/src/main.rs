...
fn main() {
    ...
    generate_candid_method!(storage_bucket, vault_file_info, query);
    generate_candid_method!(storage_bucket, vault_log, query);
    ...
    generate_ts_method!(storage_bucket, vault_file_info);
    generate_ts_method!(storage_bucket, vault_log);
