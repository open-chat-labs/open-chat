...
- Act on `UserIdMigrated`, moving everything held under the user's old id (their membership of the community and its channels, block, invitations, metrics, etc) onto their new id ([#PR](https://github.com/open-chat-labs/open-chat/pull/PR))
