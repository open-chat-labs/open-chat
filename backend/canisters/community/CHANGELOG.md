...
- Record the users who have left or been removed from the community, which nothing reads yet ([#9564](https://github.com/open-chat-labs/open-chat/pull/9564))
- Accept the `previous_user_ids` of a user joining via `c2c_join_community` or `c2c_join_channel`, and if the user was a member of the community under any of them, cache their migrations to the user's current id ([#PR](https://github.com/open-chat-labs/open-chat/pull/PR))
...
## [[2.0.1949](https://github.com/open-chat-labs/open-chat/releases/tag/v2.0.1949-community)] - 2026-01-14

### Added

- Add `c2c_bot_change_channel_role` endpoint ([#8753](https://github.com/open-chat-labs/open-chat/pull/8753))
...
## [[2.0.1899](https://github.com/open-chat-labs/open-chat/releases/tag/v2.0.1899-community)] - 2025-09-12
...
## [[2.0.1817](https://github.com/open-chat-labs/open-chat/releases/tag/v2.0.1817-community)] - 2025-07-02
...
- Treat community and chat events consistently ([#8258](https://github.com/open-chat-labs/open-chat/pull/8258))
...
## [[2.0.1741](https://github.com/open-chat-labs/open-chat/releases/tag/v2.0.1741-community)] - 2025-05-12
...
- Remove the old `c2c_can_issue_access_token_for_channel` endpoint ([#7602](https://github.com/open-chat-labs/open-chat/pull/7602))
