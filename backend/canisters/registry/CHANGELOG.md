...
- Take the token listing fee from the principal's account of a payer in a MultiUser canister, looking it up in the UserIndex, since that is their wallet
...
- Fetch the index canister for all tokens that support ICRC106 ([#8473](https://github.com/open-chat-labs/open-chat/pull/8473))
...
- Add `one_sec_enabled` to token details ([#8480](https://github.com/open-chat-labs/open-chat/pull/8480))
- Reduce frequency of checking for supported token standards ([#8481](https://github.com/open-chat-labs/open-chat/pull/8481))
...
## [[2.0.1758](https://github.com/open-chat-labs/open-chat/releases/tag/v2.0.1758-registry)] - 2025-05-21
...
## [[2.0.1685](https://github.com/open-chat-labs/open-chat/releases/tag/v2.0.1685-registry)] - 2025-04-02
...
- Remove "How to buy" urls from tokens ([#7618](https://github.com/open-chat-labs/open-chat/pull/7618))

## [[2.0.1651](https://github.com/open-chat-labs/open-chat/releases/tag/v2.0.1651-registry)] - 2025-03-13
...
- Fix check if token is ICRC1 compatible ([#7349](https://github.com/open-chat-labs/open-chat/pull/7349))
