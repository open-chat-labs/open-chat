...
export type CreateUserResponse = { 'UserLimitReached' : null } |
  { 'Success' : { 'canister' : CanisterId } } |
  { 'UserExists' : null };
export interface GetCurrentUserRequest {
  'username' : [] | [string],
...
export type GetUserResponse = { 'Success' : UserSummary } |
  { 'UserNotFound' : null };
export interface GetUsersRequest {
  'users' : Array<UserId>,
...
export interface RegisterPhoneNumberRequest { 'number' : PhoneNumber };
...
export default interface _SERVICE {
  'confirm_phone_number' : (arg_0: ConfirmPhoneNumberRequest) => Promise<
    ...
    >,
  'create' : (arg_0: CreateUserRequest) => Promise<CreateUserResponse>,
  'get_current_user' : (arg_0: GetCurrentUserRequest) => Promise<
  ...
  'metrics' : () => Promise<Metrics>,
  'notify_balance' : (arg_0: BalanceNotification) => Promise<undefined>,
  'register_phone_number' : (arg_0: RegisterPhoneNumberRequest) => Promise<
