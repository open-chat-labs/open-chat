...
pub async fn gated_register_user(
    url: String,
...
pub async fn gated_register_default_user(url: String, user_index_canister_id: CanisterId) -> UserId {
    gated_register_user(
        url,
        TestIdentity::User1,
...
pub async fn gated_register_2_default_users(url: String, user_index_canister_id: CanisterId) -> (UserId, UserId) {
    futures::future::join(
        gated_register_user(
            url.clone(),
            TestIdentity::User1,
...
pub async fn gated_register_3_default_users(url: String, user_index_canister_id: CanisterId) -> (UserId, UserId, UserId) {
