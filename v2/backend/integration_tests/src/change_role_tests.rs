    ...
    }
    {
            ...
            .unwrap()
        {
            group_canister::events_range::Response::Success(r) => {
                ...
                assert!(matches!(r.events[2].event, GroupChatEvent::ParticipantsRoleChanged(_)));
                assert!(matches!(r.events[3].event, GroupChatEvent::ParticipantsRoleChanged(_)));
                assert!(matches!(r.events[4].event, GroupChatEvent::ParticipantsRoleChanged(_)));
                assert!(matches!(r.events[5].event, GroupChatEvent::ParticipantsRoleChanged(_)));
