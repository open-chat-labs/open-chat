    ...
    <svg
        ...
        <defs>
            <linearGradient
                ...
                y2="385.502"
                id="gradient-1"
                gradientTransform="matrix(1.483987, 0, 0, 1.53077, -92.608261, -90.114895)">
            ...
            <linearGradient
                ...
                x2="188.919"
                y2="361.638"
                gradientTransform="matrix(-0.999999, 0.0016, -0.002016, -1.25907, 376.77992, 357.264546)"
                xlink:href="#gradient-5" />
        </defs>
        <rect
            style="stroke: url(#gradient-1); filter: none; stroke-width: 0px; fill-rule: nonzero; fill: url(#gradient-0);"
            x="0"
            y="0"
            width="500"
            height="500"
