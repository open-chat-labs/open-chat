...
export function uploadChunkResponse(candid: ApiUploadChunkResponse): UploadChunkResponse {
...
export function deleteBlobResponse(candid: ApiDeleteBlobResponse): DeleteBlobResponse {
    if ("Success" in candid) {
        return "success";
    }
