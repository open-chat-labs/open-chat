...
export type GetChunkResponse = { NotFound: null } | { Success: { bytes: Array<number> } };
...
export type MarkReadResponse = { SuccessNoChange: null } | { Success: null } | { NotInGroup: null };
...
export interface _SERVICE {
    ...
    remove_participants: (arg_0: RemoveParticipantsArgs) => Promise<RemoveParticipantsResponse>;
