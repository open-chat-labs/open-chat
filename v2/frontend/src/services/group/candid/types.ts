...
export type DeleteMessagesResponse = { CallerNotInGroup: null } | { Success: null };
...
export interface DismissAdminArgs {
    user_id: UserId;
}
...
export type EventsResponse = { CallerNotInGroup: null } | { Success: EventsSuccessResult };
...
export interface MakeAdminArgs {
    user_id: UserId;
}
...
export type SelectedInitialResponse =
    | { CallerNotInGroup: null }
...
export type SelectedUpdatesResponse =
    | { CallerNotInGroup: null }
...
export interface _SERVICE {
    add_participants: (arg_0: AddParticipantsArgs) => Promise<AddParticipantsResponse>;
    ...
    remove_participant: (arg_0: RemoveParticipantArgs) => Promise<RemoveParticipantResponse>;
    search_messages: (arg_0: SearchMessagesArgs) => Promise<SearchMessagesResponse>;
    selected_initial: (arg_0: SelectedInitialArgs) => Promise<SelectedInitialResponse>;
    selected_updates: (arg_0: SelectedUpdatesArgs) => Promise<SelectedUpdatesResponse>;
    ...
    transfer_ownership: (arg_0: TransferOwnershipArgs) => Promise<TransferOwnershipResponse>;
