...
export type UpdateUserCanisterWasmResponse =
    | { NotAuthorized: null }
    | { Success: null }
...
export interface _SERVICE {
    ...
    create_canister: (arg_0: CreateCanisterArgs) => Promise<CreateCanisterResponse>;
    ...
    update_user_canister_wasm: (
        arg_0: UpdateUserCanisterWasmArgs
    ) => Promise<UpdateUserCanisterWasmResponse>;
    upgrade_canister: (arg_0: UpgradeCanisterArgs) => Promise<UpgradeCanisterResponse>;
