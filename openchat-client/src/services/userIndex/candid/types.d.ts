...
export interface _SERVICE {
    ...
    confirm_phone_number: ActorMethod<[ConfirmPhoneNumberArgs], ConfirmPhoneNumberResponse>;
    create_challenge: ActorMethod<[CreateChallengeArgs], CreateChallengeResponse>;
    ...
    remove_super_admin: ActorMethod<[RemoveSuperAdminArgs], RemoveSuperAdminResponse>;
    ...
    submit_phone_number: ActorMethod<[SubmitPhoneNumberArgs], SubmitPhoneNumberResponse>;
